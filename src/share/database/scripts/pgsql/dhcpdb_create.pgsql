...
BEGIN
    ...
    IF class_index IS NULL THEN
        RAISE EXCEPTION 'Client class with id % does not exist.', class_id
            USING ERRCODE = 'sql_routine_exception';
    END IF;
    ...
    IF dependency_index IS NULL THEN
        RAISE EXCEPTION 'Client class with id % does not exist.', dependency_id
            USING ERRCODE = 'sql_routine_exception';
    END IF;
    ...
    IF dependency_index > class_index THEN
        RAISE EXCEPTION
            ...
            class_id, dependency_id USING ERRCODE = 'sql_routine_exception';
    END IF;
