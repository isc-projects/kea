...
#line 141 "dhcp6_parser.h" // lalr1.cc:377
  ...
  public:
    ...
    struct token
    {
      enum yytokentype
      {
        ...
        TOKEN_EVAL_CLIENT_CLASSES = 329,
        TOKEN_TEST = 330,
        TOKEN_EVAL_ON_DEMAND = 331,
        ...
        TOKEN_ALWAYS = 383,
        TOKEN_WHEN_NOT_PRESENT = 384,
        TOKEN_LOGGING = 385,
        TOKEN_LOGGERS = 386,
        TOKEN_OUTPUT_OPTIONS = 387,
        TOKEN_OUTPUT = 388,
        TOKEN_DEBUGLEVEL = 389,
        TOKEN_SEVERITY = 390,
        TOKEN_FLUSH = 391,
        TOKEN_MAXSIZE = 392,
        TOKEN_MAXVER = 393,
        TOKEN_DHCP4 = 394,
        TOKEN_DHCPDDNS = 395,
        TOKEN_CONTROL_AGENT = 396,
        TOKEN_TOPLEVEL_JSON = 397,
        TOKEN_TOPLEVEL_DHCP6 = 398,
        TOKEN_SUB_DHCP6 = 399,
        TOKEN_SUB_INTERFACES6 = 400,
        TOKEN_SUB_SUBNET6 = 401,
        TOKEN_SUB_POOL6 = 402,
        TOKEN_SUB_PD_POOL = 403,
  ...
  basic_symbol (typename Base::kind_type t, const std::string v, const location_type& l);
    ...
    static inline
    symbol_type
    make_KNOWN_CLIENTS (const location_type& l);
  ...
  private:
    ...
    {
      yyeof_ = 0,
      yylast_ = 858,     ///< Last index in yytable_.
  ...
  Dhcp6Parser::symbol_type
  Dhcp6Parser::make_KNOWN_CLIENTS (const location_type& l)
  {
    return symbol_type (token::TOKEN_KNOWN_CLIENTS, l);
  }

  Dhcp6Parser::symbol_type
  Dhcp6Parser::make_ONLY (const location_type& l)
  {
    return symbol_type (token::TOKEN_ONLY, l);
  }
...
#line 2797 "dhcp6_parser.h" // lalr1.cc:377
