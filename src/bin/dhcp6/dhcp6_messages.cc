...
const char* values[] = {
    ...
    "DHCP6_PACKET_DROP_DUPLICATE", "dropped as sent by the same client as a packet being processed by another thread: dropped %1 %2 by thread %3 as duplicate of %4 processed by thread %5",
