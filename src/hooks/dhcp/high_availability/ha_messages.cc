...
const char* values[] = {
    ...
    "HA_CONFIG_AUTO_FAILOVER_DISABLED", "%1 relationship: auto-failover disabled",
    ...
    "HA_CONFIG_LEASE_SYNCING_DISABLED", "%1 relationship: lease database synchronization between HA servers is disabled",
    ...
    "HA_CONFIG_LEASE_UPDATES_AND_SYNCING_DIFFER", "%1 relationship: unusual configuration where \"send-lease-updates\": %1 and \"sync-leases\": %2",
    "HA_CONFIG_LEASE_UPDATES_DISABLED", "%1 relationship: lease updates will not be generated",
