  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_adaptive_lease_time_threshold = 290,   // adaptive_lease_time_threshold
        ...
        S_399_48 = 399,                          // $@48
        S_ssl_mode = 400,                        // ssl_mode
        S_401_49 = 401,                          // $@49
        S_cipher_list = 402,                     // cipher_list
        S_403_50 = 403,                          // $@50
        S_host_reservation_identifiers = 404,    // host_reservation_identifiers
        S_405_51 = 405,                          // $@51
        S_host_reservation_identifiers_list = 406, // host_reservation_identifiers_list
        S_host_reservation_identifier = 407,     // host_reservation_identifier
        S_duid_id = 408,                         // duid_id
        S_hw_address_id = 409,                   // hw_address_id
        S_circuit_id = 410,                      // circuit_id
        S_client_id = 411,                       // client_id
        S_flex_id = 412,                         // flex_id
        ...
        S_subnet4_list = 444,                    // subnet4_list
        S_445_59 = 445,                          // $@59
        S_subnet4_list_content = 446,            // subnet4_list_content
        S_not_empty_subnet4_list = 447,          // not_empty_subnet4_list
        S_subnet4 = 448,                         // subnet4
        S_449_60 = 449,                          // $@60
        S_sub_subnet4 = 450,                     // sub_subnet4
        S_451_61 = 451,                          // $@61
        S_subnet4_params = 452,                  // subnet4_params
        S_subnet4_param = 453,                   // subnet4_param
        S_subnet = 454,                          // subnet
        S_455_62 = 455,                          // $@62
        S_subnet_4o6_interface = 456,            // subnet_4o6_interface
        S_457_63 = 457,                          // $@63
        S_subnet_4o6_interface_id = 458,         // subnet_4o6_interface_id
        S_459_64 = 459,                          // $@64
        S_subnet_4o6_subnet = 460,               // subnet_4o6_subnet
        S_461_65 = 461,                          // $@65
        S_interface = 462,                       // interface
        S_463_66 = 463,                          // $@66
        S_client_class = 464,                    // client_class
        S_465_67 = 465,                          // $@67
        S_network_client_classes = 466,          // network_client_classes
        S_467_68 = 467,                          // $@68
        S_require_client_classes = 468,          // require_client_classes
        S_469_69 = 469,                          // $@69
        S_evaluate_additional_classes = 470,     // evaluate_additional_classes
        S_471_70 = 471,                          // $@70
        S_reservations_global = 472,             // reservations_global
        S_reservations_in_subnet = 473,          // reservations_in_subnet
        S_reservations_out_of_pool = 474,        // reservations_out_of_pool
        S_id = 475,                              // id
        S_shared_networks = 476,                 // shared_networks
        S_477_71 = 477,                          // $@71
        S_shared_networks_content = 478,         // shared_networks_content
        S_shared_networks_list = 479,            // shared_networks_list
        S_shared_network = 480,                  // shared_network
        S_481_72 = 481,                          // $@72
        S_shared_network_params = 482,           // shared_network_params
        S_shared_network_param = 483,            // shared_network_param
        S_option_def_list = 484,                 // option_def_list
        S_485_73 = 485,                          // $@73
        S_sub_option_def_list = 486,             // sub_option_def_list
        S_487_74 = 487,                          // $@74
        S_option_def_list_content = 488,         // option_def_list_content
        S_not_empty_option_def_list = 489,       // not_empty_option_def_list
        S_option_def_entry = 490,                // option_def_entry
        S_491_75 = 491,                          // $@75
        S_sub_option_def = 492,                  // sub_option_def
        S_493_76 = 493,                          // $@76
        S_option_def_params = 494,               // option_def_params
        S_not_empty_option_def_params = 495,     // not_empty_option_def_params
        S_option_def_param = 496,                // option_def_param
        S_option_def_name = 497,                 // option_def_name
        S_code = 498,                            // code
        S_option_def_code = 499,                 // option_def_code
        S_option_def_type = 500,                 // option_def_type
        S_501_77 = 501,                          // $@77
        S_option_def_record_types = 502,         // option_def_record_types
        S_503_78 = 503,                          // $@78
        S_space = 504,                           // space
        S_505_79 = 505,                          // $@79
        S_option_def_space = 506,                // option_def_space
        S_option_def_encapsulate = 507,          // option_def_encapsulate
        S_508_80 = 508,                          // $@80
        S_option_def_array = 509,                // option_def_array
        S_option_data_list = 510,                // option_data_list
        S_511_81 = 511,                          // $@81
        S_option_data_list_content = 512,        // option_data_list_content
        S_not_empty_option_data_list = 513,      // not_empty_option_data_list
        S_option_data_entry = 514,               // option_data_entry
        S_515_82 = 515,                          // $@82
        S_sub_option_data = 516,                 // sub_option_data
        S_517_83 = 517,                          // $@83
        S_option_data_params = 518,              // option_data_params
        S_not_empty_option_data_params = 519,    // not_empty_option_data_params
        S_option_data_param = 520,               // option_data_param
        S_option_data_name = 521,                // option_data_name
        S_option_data_data = 522,                // option_data_data
        S_523_84 = 523,                          // $@84
        S_option_data_code = 524,                // option_data_code
        S_option_data_space = 525,               // option_data_space
        S_option_data_csv_format = 526,          // option_data_csv_format
        S_option_data_always_send = 527,         // option_data_always_send
        S_option_data_never_send = 528,          // option_data_never_send
        S_option_data_client_classes = 529,      // option_data_client_classes
        S_530_85 = 530,                          // $@85
        S_pools_list = 531,                      // pools_list
        S_532_86 = 532,                          // $@86
        S_pools_list_content = 533,              // pools_list_content
        S_not_empty_pools_list = 534,            // not_empty_pools_list
        S_pool_list_entry = 535,                 // pool_list_entry
        S_536_87 = 536,                          // $@87
        S_sub_pool4 = 537,                       // sub_pool4
        S_538_88 = 538,                          // $@88
        S_pool_params = 539,                     // pool_params
        S_pool_param = 540,                      // pool_param
        S_pool_entry = 541,                      // pool_entry
        S_542_89 = 542,                          // $@89
        S_pool_id = 543,                         // pool_id
        S_user_context = 544,                    // user_context
        S_545_90 = 545,                          // $@90
        S_comment = 546,                         // comment
        S_547_91 = 547,                          // $@91
        S_reservations = 548,                    // reservations
        S_549_92 = 549,                          // $@92
        S_reservations_list = 550,               // reservations_list
        S_not_empty_reservations_list = 551,     // not_empty_reservations_list
        S_reservation = 552,                     // reservation
        S_553_93 = 553,                          // $@93
        S_sub_reservation = 554,                 // sub_reservation
        S_555_94 = 555,                          // $@94
        S_reservation_params = 556,              // reservation_params
        S_not_empty_reservation_params = 557,    // not_empty_reservation_params
        S_reservation_param = 558,               // reservation_param
        S_next_server = 559,                     // next_server
        S_560_95 = 560,                          // $@95
        S_server_hostname = 561,                 // server_hostname
        S_562_96 = 562,                          // $@96
        S_boot_file_name = 563,                  // boot_file_name
        S_564_97 = 564,                          // $@97
        S_ip_address = 565,                      // ip_address
        S_566_98 = 566,                          // $@98
        S_duid = 567,                            // duid
        S_568_99 = 568,                          // $@99
        S_hw_address = 569,                      // hw_address
        S_570_100 = 570,                         // $@100
        S_client_id_value = 571,                 // client_id_value
        S_572_101 = 572,                         // $@101
        S_circuit_id_value = 573,                // circuit_id_value
        S_574_102 = 574,                         // $@102
        S_flex_id_value = 575,                   // flex_id_value
        S_576_103 = 576,                         // $@103
        S_hostname = 577,                        // hostname
        S_578_104 = 578,                         // $@104
        S_reservation_client_classes = 579,      // reservation_client_classes
        S_580_105 = 580,                         // $@105
        S_relay = 581,                           // relay
        S_582_106 = 582,                         // $@106
        S_relay_map = 583,                       // relay_map
        S_ip_addresses = 584,                    // ip_addresses
        S_585_107 = 585,                         // $@107
        S_client_classes = 586,                  // client_classes
        S_587_108 = 587,                         // $@108
        S_client_classes_list = 588,             // client_classes_list
        S_not_empty_classes_list = 589,          // not_empty_classes_list
