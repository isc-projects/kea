  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_not_empty_classes_list = 580,          // not_empty_classes_list
        S_client_class_entry = 581,              // client_class_entry
        S_582_108 = 582,                         // $@108
        S_client_class_params = 583,             // client_class_params
        S_not_empty_client_class_params = 584,   // not_empty_client_class_params
        S_client_class_param = 585,              // client_class_param
        S_client_class_name = 586,               // client_class_name
        S_client_class_test = 587,               // client_class_test
        S_588_109 = 588,                         // $@109
        S_client_class_template_test = 589,      // client_class_template_test
        S_590_110 = 590,                         // $@110
        S_only_if_required = 591,                // only_if_required
        S_only_in_additional_list = 592,         // only_in_additional_list
        S_dhcp4o6_port = 593,                    // dhcp4o6_port
        S_control_socket = 594,                  // control_socket
        S_595_111 = 595,                         // $@111
        S_control_sockets = 596,                 // control_sockets
        S_597_112 = 597,                         // $@112
        S_control_socket_list = 598,             // control_socket_list
        S_not_empty_control_socket_list = 599,   // not_empty_control_socket_list
        S_control_socket_entry = 600,            // control_socket_entry
        S_601_113 = 601,                         // $@113
        S_control_socket_params = 602,           // control_socket_params
        S_control_socket_param = 603,            // control_socket_param
        S_control_socket_type = 604,             // control_socket_type
        S_605_114 = 605,                         // $@114
        S_control_socket_type_value = 606,       // control_socket_type_value
        S_control_socket_name = 607,             // control_socket_name
        S_608_115 = 608,                         // $@115
        S_control_socket_address = 609,          // control_socket_address
        S_610_116 = 610,                         // $@116
        S_control_socket_port = 611,             // control_socket_port
        S_cert_required = 612,                   // cert_required
        S_http_headers = 613,                    // http_headers
        S_614_117 = 614,                         // $@117
        S_http_header_list = 615,                // http_header_list
        S_not_empty_http_header_list = 616,      // not_empty_http_header_list
        S_http_header = 617,                     // http_header
        S_618_118 = 618,                         // $@118
        S_http_header_params = 619,              // http_header_params
        S_http_header_param = 620,               // http_header_param
        S_header_value = 621,                    // header_value
        S_622_119 = 622,                         // $@119
        ...
        S_ignore_dhcp_server_identifier = 713,   // ignore_dhcp_server_identifier
        S_ignore_rai_link_selection = 714,       // ignore_rai_link_selection
        S_exclude_first_last_24 = 715            // exclude_first_last_24
      };
    };
...
switch (yykind)
  ...
  private:
    ...
    enum
    {
      yylast_ = 1633,     ///< Last index in yytable_.
      yynnts_ = 482,  ///< Number of nonterminal symbols.
