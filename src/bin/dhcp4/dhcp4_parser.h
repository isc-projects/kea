  ...
  private:
    ...
    struct token
    {
      enum yytokentype
      {
        ...
        TOKEN_RE_DETECT = 277,
        TOKEN_SERVICE_SOCKETS_REQUIRE_ALL = 278,
        TOKEN_SERVICE_SOCKETS_RETRY_WAIT_TIME = 279,
        TOKEN_SERVICE_SOCKETS_MAX_RETRIES = 280,
        TOKEN_SANITY_CHECKS = 281,
        TOKEN_LEASE_CHECKS = 282,
        TOKEN_ECHO_CLIENT_ID = 283,
        TOKEN_MATCH_CLIENT_ID = 284,
        TOKEN_AUTHORITATIVE = 285,
        TOKEN_NEXT_SERVER = 286,
        TOKEN_SERVER_HOSTNAME = 287,
        TOKEN_BOOT_FILE_NAME = 288,
        TOKEN_LEASE_DATABASE = 289,
        TOKEN_HOSTS_DATABASE = 290,
        TOKEN_HOSTS_DATABASES = 291,
        TOKEN_TYPE = 292,
        TOKEN_MEMFILE = 293,
        TOKEN_MYSQL = 294,
        TOKEN_POSTGRESQL = 295,
        TOKEN_USER = 296,
        TOKEN_PASSWORD = 297,
        TOKEN_HOST = 298,
        TOKEN_PORT = 299,
        TOKEN_PERSIST = 300,
        TOKEN_LFC_INTERVAL = 301,
        TOKEN_READONLY = 302,
        TOKEN_CONNECT_TIMEOUT = 303,
        TOKEN_MAX_RECONNECT_TRIES = 304,
        TOKEN_RECONNECT_WAIT_TIME = 305,
        TOKEN_ON_FAIL = 306,
        TOKEN_STOP_RETRY_EXIT = 307,
        TOKEN_SERVE_RETRY_EXIT = 308,
        TOKEN_SERVE_RETRY_CONTINUE = 309,
        TOKEN_MAX_ROW_ERRORS = 310,
        TOKEN_TRUST_ANCHOR = 311,
        TOKEN_CERT_FILE = 312,
        TOKEN_KEY_FILE = 313,
        TOKEN_CIPHER_LIST = 314,
        TOKEN_VALID_LIFETIME = 315,
        TOKEN_MIN_VALID_LIFETIME = 316,
        TOKEN_MAX_VALID_LIFETIME = 317,
        TOKEN_RENEW_TIMER = 318,
        TOKEN_REBIND_TIMER = 319,
        TOKEN_CALCULATE_TEE_TIMES = 320,
        TOKEN_T1_PERCENT = 321,
        TOKEN_T2_PERCENT = 322,
        TOKEN_CACHE_THRESHOLD = 323,
        TOKEN_CACHE_MAX_AGE = 324,
        TOKEN_DECLINE_PROBATION_PERIOD = 325,
        TOKEN_SERVER_TAG = 326,
        TOKEN_STATISTIC_DEFAULT_SAMPLE_COUNT = 327,
        TOKEN_STATISTIC_DEFAULT_SAMPLE_AGE = 328,
        TOKEN_DDNS_SEND_UPDATES = 329,
        TOKEN_DDNS_OVERRIDE_NO_UPDATE = 330,
        TOKEN_DDNS_OVERRIDE_CLIENT_UPDATE = 331,
        TOKEN_DDNS_REPLACE_CLIENT_NAME = 332,
        TOKEN_DDNS_GENERATED_PREFIX = 333,
        TOKEN_DDNS_QUALIFYING_SUFFIX = 334,
        TOKEN_DDNS_UPDATE_ON_RENEW = 335,
        TOKEN_DDNS_USE_CONFLICT_RESOLUTION = 336,
        TOKEN_STORE_EXTENDED_INFO = 337,
        TOKEN_SUBNET4 = 338,
        TOKEN_SUBNET_4O6_INTERFACE = 339,
        TOKEN_SUBNET_4O6_INTERFACE_ID = 340,
        TOKEN_SUBNET_4O6_SUBNET = 341,
        TOKEN_OPTION_DEF = 342,
        TOKEN_OPTION_DATA = 343,
        TOKEN_NAME = 344,
        TOKEN_DATA = 345,
        TOKEN_CODE = 346,
        TOKEN_SPACE = 347,
        TOKEN_CSV_FORMAT = 348,
        TOKEN_ALWAYS_SEND = 349,
        TOKEN_RECORD_TYPES = 350,
        TOKEN_ENCAPSULATE = 351,
        TOKEN_ARRAY = 352,
        TOKEN_PARKED_PACKET_LIMIT = 353,
        ...
        TOKEN_EARLY_GLOBAL_RESERVATIONS_LOOKUP = 430,
        TOKEN_IP_RESERVATIONS_UNIQUE = 431,
        TOKEN_RESERVATIONS_LOOKUP_FIRST = 432,
        TOKEN_LOGGERS = 433,
        TOKEN_OUTPUT_OPTIONS = 434,
        TOKEN_OUTPUT = 435,
        TOKEN_DEBUGLEVEL = 436,
        TOKEN_SEVERITY = 437,
        TOKEN_FLUSH = 438,
        TOKEN_MAXSIZE = 439,
        TOKEN_MAXVER = 440,
        TOKEN_PATTERN = 441,
        TOKEN_COMPATIBILITY = 442,
        TOKEN_LENIENT_OPTION_PARSING = 443,
        TOKEN_TOPLEVEL_JSON = 444,
        TOKEN_TOPLEVEL_DHCP4 = 445,
        TOKEN_SUB_DHCP4 = 446,
        TOKEN_SUB_INTERFACES4 = 447,
        TOKEN_SUB_SUBNET4 = 448,
        TOKEN_SUB_POOL4 = 449,
        TOKEN_SUB_RESERVATION = 450,
        TOKEN_SUB_OPTION_DEFS = 451,
        TOKEN_SUB_OPTION_DEF = 452,
        TOKEN_SUB_OPTION_DATA = 453,
        TOKEN_SUB_HOOKS_LIBRARY = 454,
        TOKEN_SUB_DHCP_DDNS = 455,
        TOKEN_SUB_CONFIG_CONTROL = 456,
        TOKEN_STRING = 457,
        TOKEN_INTEGER = 458,
        TOKEN_FLOAT = 459,
        TOKEN_BOOLEAN = 460
...
switch (yytype)
    {
      ...
      case 295: // socket_type
      case 298: // outbound_interface_value
      case 323: // db_type
      case 341: // on_fail_mode
      case 420: // hr_mode
      case 575: // ncr_protocol_value
  ...
  Dhcp4Parser::yytranslate_ (int t)
  {
    ...
    const int user_token_number_max_ = 460;
