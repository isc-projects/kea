  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_option_data_client_classes = 512,      // option_data_client_classes
        S_513_83 = 513,                          // $@83
        S_pools_list = 514,                      // pools_list
        S_515_84 = 515,                          // $@84
        S_pools_list_content = 516,              // pools_list_content
        S_not_empty_pools_list = 517,            // not_empty_pools_list
        S_pool_list_entry = 518,                 // pool_list_entry
        S_519_85 = 519,                          // $@85
        S_sub_pool4 = 520,                       // sub_pool4
        S_521_86 = 521,                          // $@86
        S_pool_params = 522,                     // pool_params
        S_pool_param = 523,                      // pool_param
        S_pool_entry = 524,                      // pool_entry
        S_525_87 = 525,                          // $@87
        S_pool_id = 526,                         // pool_id
        S_user_context = 527,                    // user_context
        S_528_88 = 528,                          // $@88
        S_comment = 529,                         // comment
        S_530_89 = 530,                          // $@89
        S_reservations = 531,                    // reservations
        S_532_90 = 532,                          // $@90
        S_reservations_list = 533,               // reservations_list
        S_not_empty_reservations_list = 534,     // not_empty_reservations_list
        S_reservation = 535,                     // reservation
        S_536_91 = 536,                          // $@91
        S_sub_reservation = 537,                 // sub_reservation
        S_538_92 = 538,                          // $@92
        S_reservation_params = 539,              // reservation_params
        S_not_empty_reservation_params = 540,    // not_empty_reservation_params
        S_reservation_param = 541,               // reservation_param
        S_next_server = 542,                     // next_server
        S_543_93 = 543,                          // $@93
        S_server_hostname = 544,                 // server_hostname
        S_545_94 = 545,                          // $@94
        S_boot_file_name = 546,                  // boot_file_name
        S_547_95 = 547,                          // $@95
        ...
        S_553_98 = 553,                          // $@98
        S_client_id_value = 554,                 // client_id_value
        S_555_99 = 555,                          // $@99
        S_circuit_id_value = 556,                // circuit_id_value
        S_557_100 = 557,                         // $@100
        S_flex_id_value = 558,                   // flex_id_value
        S_559_101 = 559,                         // $@101
        S_hostname = 560,                        // hostname
        S_561_102 = 561,                         // $@102
        S_reservation_client_classes = 562,      // reservation_client_classes
        S_563_103 = 563,                         // $@103
        S_relay = 564,                           // relay
        S_565_104 = 565,                         // $@104
        S_relay_map = 566,                       // relay_map
        S_ip_addresses = 567,                    // ip_addresses
        S_568_105 = 568,                         // $@105
        S_client_classes = 569,                  // client_classes
        S_570_106 = 570,                         // $@106
        S_client_classes_list = 571,             // client_classes_list
        S_client_class_entry = 572,              // client_class_entry
        S_573_107 = 573,                         // $@107
        S_client_class_params = 574,             // client_class_params
        S_not_empty_client_class_params = 575,   // not_empty_client_class_params
        S_client_class_param = 576,              // client_class_param
        S_client_class_name = 577,               // client_class_name
        S_client_class_test = 578,               // client_class_test
        S_579_108 = 579,                         // $@108
        S_client_class_template_test = 580,      // client_class_template_test
        S_581_109 = 581,                         // $@109
        S_only_if_required = 582,                // only_if_required
        S_only_in_additional_list = 583,         // only_in_additional_list
        S_dhcp4o6_port = 584,                    // dhcp4o6_port
        S_control_socket = 585,                  // control_socket
        S_586_110 = 586,                         // $@110
        S_control_sockets = 587,                 // control_sockets
        S_588_111 = 588,                         // $@111
        S_control_socket_list = 589,             // control_socket_list
        S_not_empty_control_socket_list = 590,   // not_empty_control_socket_list
        S_control_socket_entry = 591,            // control_socket_entry
        S_592_112 = 592,                         // $@112
        S_control_socket_params = 593,           // control_socket_params
        S_control_socket_param = 594,            // control_socket_param
        S_control_socket_type = 595,             // control_socket_type
        S_596_113 = 596,                         // $@113
        S_control_socket_type_value = 597,       // control_socket_type_value
        S_control_socket_name = 598,             // control_socket_name
        S_599_114 = 599,                         // $@114
        S_control_socket_address = 600,          // control_socket_address
        S_601_115 = 601,                         // $@115
        S_control_socket_port = 602,             // control_socket_port
        S_cert_required = 603,                   // cert_required
        S_http_headers = 604,                    // http_headers
        S_605_116 = 605,                         // $@116
        S_http_header_list = 606,                // http_header_list
        S_not_empty_http_header_list = 607,      // not_empty_http_header_list
        S_http_header = 608,                     // http_header
        S_609_117 = 609,                         // $@117
