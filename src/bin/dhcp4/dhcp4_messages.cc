// File created from ../../../src/bin/dhcp4/dhcp4_messages.mes on Wed Oct 28 2020 14:29
...
extern const isc::log::MessageID DHCP4_DEPRECATED_RESERVATION_MODE = "DHCP4_DEPRECATED_RESERVATION_MODE";
