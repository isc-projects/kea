  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_not_empty_classes_list = 592,          // not_empty_classes_list
        S_client_class_entry = 593,              // client_class_entry
        S_594_110 = 594,                         // $@110
        S_client_class_params = 595,             // client_class_params
        S_not_empty_client_class_params = 596,   // not_empty_client_class_params
        S_client_class_param = 597,              // client_class_param
        S_client_class_name = 598,               // client_class_name
        S_client_class_test = 599,               // client_class_test
        S_600_111 = 600,                         // $@111
        S_client_class_template_test = 601,      // client_class_template_test
        S_602_112 = 602,                         // $@112
        S_only_if_required = 603,                // only_if_required
        S_only_in_additional_list = 604,         // only_in_additional_list
        S_server_id = 605,                       // server_id
        S_606_113 = 606,                         // $@113
        S_server_id_params = 607,                // server_id_params
        S_server_id_param = 608,                 // server_id_param
        S_server_id_type = 609,                  // server_id_type
        S_610_114 = 610,                         // $@114
        S_duid_type = 611,                       // duid_type
        S_htype = 612,                           // htype
        S_identifier = 613,                      // identifier
        S_614_115 = 614,                         // $@115
        S_time = 615,                            // time
        S_enterprise_id = 616,                   // enterprise_id
        S_dhcp4o6_port = 617,                    // dhcp4o6_port
        S_control_socket = 618,                  // control_socket
        S_619_116 = 619,                         // $@116
        S_control_sockets = 620,                 // control_sockets
        S_621_117 = 621,                         // $@117
        S_control_socket_list = 622,             // control_socket_list
        S_not_empty_control_socket_list = 623,   // not_empty_control_socket_list
        S_control_socket_entry = 624,            // control_socket_entry
        S_625_118 = 625,                         // $@118
        S_control_socket_params = 626,           // control_socket_params
        S_control_socket_param = 627,            // control_socket_param
        S_control_socket_type = 628,             // control_socket_type
        S_629_119 = 629,                         // $@119
        S_control_socket_type_value = 630,       // control_socket_type_value
        S_control_socket_name = 631,             // control_socket_name
        S_632_120 = 632,                         // $@120
        S_control_socket_address = 633,          // control_socket_address
        S_634_121 = 634,                         // $@121
        S_control_socket_port = 635,             // control_socket_port
        S_cert_required = 636,                   // cert_required
        S_http_headers = 637,                    // http_headers
        S_638_122 = 638,                         // $@122
        S_http_header_list = 639,                // http_header_list
        S_not_empty_http_header_list = 640,      // not_empty_http_header_list
        S_http_header = 641,                     // http_header
        S_642_123 = 642,                         // $@123
        S_http_header_params = 643,              // http_header_params
        S_http_header_param = 644,               // http_header_param
        S_header_value = 645,                    // header_value
        S_646_124 = 646,                         // $@124
        S_authentication = 647,                  // authentication
        S_648_125 = 648,                         // $@125
        S_auth_params = 649,                     // auth_params
        S_auth_param = 650,                      // auth_param
        S_auth_type = 651,                       // auth_type
        S_652_126 = 652,                         // $@126
        S_auth_type_value = 653,                 // auth_type_value
        S_realm = 654,                           // realm
        S_655_127 = 655,                         // $@127
        S_directory = 656,                       // directory
        S_657_128 = 657,                         // $@128
        S_clients = 658,                         // clients
        S_659_129 = 659,                         // $@129
        S_clients_list = 660,                    // clients_list
        S_not_empty_clients_list = 661,          // not_empty_clients_list
        S_basic_auth = 662,                      // basic_auth
        S_663_130 = 663,                         // $@130
        S_clients_params = 664,                  // clients_params
        S_clients_param = 665,                   // clients_param
        S_user_file = 666,                       // user_file
        S_667_131 = 667,                         // $@131
        S_password_file = 668,                   // password_file
        S_669_132 = 669,                         // $@132
        S_dhcp_queue_control = 670,              // dhcp_queue_control
        S_671_133 = 671,                         // $@133
        S_queue_control_params = 672,            // queue_control_params
        S_queue_control_param = 673,             // queue_control_param
        S_enable_queue = 674,                    // enable_queue
        S_queue_type = 675,                      // queue_type
        S_676_134 = 676,                         // $@134
        S_capacity = 677,                        // capacity
        S_arbitrary_map_entry = 678,             // arbitrary_map_entry
        S_679_135 = 679,                         // $@135
        S_dhcp_ddns = 680,                       // dhcp_ddns
        S_681_136 = 681,                         // $@136
        S_sub_dhcp_ddns = 682,                   // sub_dhcp_ddns
        S_683_137 = 683,                         // $@137
        S_dhcp_ddns_params = 684,                // dhcp_ddns_params
        S_dhcp_ddns_param = 685,                 // dhcp_ddns_param
        S_enable_updates = 686,                  // enable_updates
        S_server_ip = 687,                       // server_ip
        S_688_138 = 688,                         // $@138
        S_server_port = 689,                     // server_port
        S_sender_ip = 690,                       // sender_ip
        S_691_139 = 691,                         // $@139
        S_sender_port = 692,                     // sender_port
        S_max_queue_size = 693,                  // max_queue_size
        S_ncr_protocol = 694,                    // ncr_protocol
        S_695_140 = 695,                         // $@140
        S_ncr_protocol_value = 696,              // ncr_protocol_value
        S_ncr_format = 697,                      // ncr_format
        S_698_141 = 698,                         // $@141
        S_config_control = 699,                  // config_control
        S_700_142 = 700,                         // $@142
        S_sub_config_control = 701,              // sub_config_control
        S_702_143 = 702,                         // $@143
        S_config_control_params = 703,           // config_control_params
        S_config_control_param = 704,            // config_control_param
        S_config_databases = 705,                // config_databases
        S_706_144 = 706,                         // $@144
        S_config_fetch_wait_time = 707,          // config_fetch_wait_time
        S_loggers = 708,                         // loggers
        S_709_145 = 709,                         // $@145
        S_loggers_entries = 710,                 // loggers_entries
        S_logger_entry = 711,                    // logger_entry
        S_712_146 = 712,                         // $@146
        S_logger_params = 713,                   // logger_params
        S_logger_param = 714,                    // logger_param
        S_debuglevel = 715,                      // debuglevel
        S_severity = 716,                        // severity
        S_717_147 = 717,                         // $@147
        S_output_options_list = 718,             // output_options_list
        S_719_148 = 719,                         // $@148
        S_output_options_list_content = 720,     // output_options_list_content
        S_output_entry = 721,                    // output_entry
        S_722_149 = 722,                         // $@149
        S_output_params_list = 723,              // output_params_list
        S_output_params = 724,                   // output_params
        S_output = 725,                          // output
        S_726_150 = 726,                         // $@150
        S_flush = 727,                           // flush
        S_maxsize = 728,                         // maxsize
        S_maxver = 729,                          // maxver
        S_pattern = 730,                         // pattern
        S_731_151 = 731,                         // $@151
        S_compatibility = 732,                   // compatibility
        S_733_152 = 733,                         // $@152
        S_compatibility_params = 734,            // compatibility_params
        S_compatibility_param = 735,             // compatibility_param
        S_lenient_option_parsing = 736           // lenient_option_parsing
      };
    };
...
switch (yykind)
  ...
  private:
    ...
    enum
    {
      yylast_ = 1672,     ///< Last index in yytable_.
      yynnts_ = 499,  ///< Number of nonterminal symbols.
