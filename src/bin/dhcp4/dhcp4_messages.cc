...
extern const isc::log::MessageID DHCP4_CB_REPAIR_MODE_ENABLED = "DHCP4_CB_REPAIR_MODE_ENABLED";
...
extern const isc::log::MessageID DHCP4_PACKET_NAK_0005 = "DHCP4_PACKET_NAK_0005";
...
const char* values[] = {
    ...
    "DHCP4_CB_REPAIR_MODE_ENABLED", "Server is running in config back end repair mode.",
    ...
    "DHCP4_CLIENT_FQDN_SCRUBBED_EMPTY", "%1: sanitizing client's FQDN option '%2' yielded an empty name or an empty label within the name",
    ...
    "DHCP4_CLIENT_HOSTNAME_SCRUBBED_EMPTY", "%1: sanitizing client's Hostname option '%2' yielded an empty name or an empty label within the name",
    ...
    "DHCP4_PACKET_DROP_0011", "dropped as sent by the same client than a packet being processed by another thread: dropped %1, %2 by thread %3 as duplicate of %4 processed by thread %5",
    "DHCP4_PACKET_DROP_0012", "dropped as sent by the same client than a packet being processed by another thread: dropped %1, %2 by thread %3 as duplicate of %4 processed by thread %5",
    ...
    "DHCP4_PACKET_NAK_0005", "nacked as member of the special class 'REJECT': %1, %2",
