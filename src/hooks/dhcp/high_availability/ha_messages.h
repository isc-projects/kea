...
extern const isc::log::MessageID HA_LEASES6_COMMITTED_NO_RELATIONSHIP;
...
extern const isc::log::MessageID HA_SUBNET4_SELECT_FAILED;
extern const isc::log::MessageID HA_SUBNET4_SELECT_INVALID_HA_SERVER_NAME;
