...
extern const isc::log::MessageID TCP_CLIENT_BAD_SERVER_RESPONSE_RECEIVED;
extern const isc::log::MessageID TCP_CLIENT_BAD_SERVER_RESPONSE_RECEIVED_DETAILS;
extern const isc::log::MessageID TCP_CLIENT_CONNECTION_CLOSE_CALLBACK_FAILED;
extern const isc::log::MessageID TCP_CLIENT_MT_STARTED;
extern const isc::log::MessageID TCP_CLIENT_PREMATURE_CONNECTION_TIMEOUT_OCCURRED;
extern const isc::log::MessageID TCP_CLIENT_QUEUE_SIZE_GROWING;
extern const isc::log::MessageID TCP_CLIENT_REQUEST_SEND;
extern const isc::log::MessageID TCP_CLIENT_SERVER_RESPONSE_RECEIVED;
...
extern const isc::log::MessageID TCP_SERVER_CLIENT_REQUEST_RECEIVED;
