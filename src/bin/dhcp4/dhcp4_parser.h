  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_375_42 = 375,                          // $@42
        S_password_file = 376,                   // password_file
        S_377_43 = 377,                          // $@43
        S_host = 378,                            // host
        S_379_44 = 379,                          // $@44
        S_port = 380,                            // port
        S_name = 381,                            // name
        S_382_45 = 382,                          // $@45
        S_persist = 383,                         // persist
        S_lfc_interval = 384,                    // lfc_interval
        S_readonly = 385,                        // readonly
        S_connect_timeout = 386,                 // connect_timeout
        S_read_timeout = 387,                    // read_timeout
        S_write_timeout = 388,                   // write_timeout
        S_tcp_user_timeout = 389,                // tcp_user_timeout
        S_max_reconnect_tries = 390,             // max_reconnect_tries
        S_reconnect_wait_time = 391,             // reconnect_wait_time
        S_on_fail = 392,                         // on_fail
        S_393_46 = 393,                          // $@46
        S_on_fail_mode = 394,                    // on_fail_mode
        S_retry_on_startup = 395,                // retry_on_startup
        S_max_row_errors = 396,                  // max_row_errors
        S_trust_anchor = 397,                    // trust_anchor
        S_398_47 = 398,                          // $@47
        S_cert_file = 399,                       // cert_file
        S_400_48 = 400,                          // $@48
        S_key_file = 401,                        // key_file
        S_402_49 = 402,                          // $@49
        S_ssl_mode = 403,                        // ssl_mode
        S_404_50 = 404,                          // $@50
        S_cipher_list = 405,                     // cipher_list
        S_406_51 = 406,                          // $@51
        S_host_reservation_identifiers = 407,    // host_reservation_identifiers
        S_408_52 = 408,                          // $@52
        S_host_reservation_identifiers_list = 409, // host_reservation_identifiers_list
        S_host_reservation_identifier = 410,     // host_reservation_identifier
        S_duid_id = 411,                         // duid_id
        S_hw_address_id = 412,                   // hw_address_id
        S_circuit_id = 413,                      // circuit_id
        S_client_id = 414,                       // client_id
        S_flex_id = 415,                         // flex_id
        S_dhcp_multi_threading = 416,            // dhcp_multi_threading
        S_417_53 = 417,                          // $@53
        S_multi_threading_params = 418,          // multi_threading_params
        S_multi_threading_param = 419,           // multi_threading_param
        S_enable_multi_threading = 420,          // enable_multi_threading
        S_thread_pool_size = 421,                // thread_pool_size
        S_packet_queue_size = 422,               // packet_queue_size
        S_hooks_libraries = 423,                 // hooks_libraries
        S_424_54 = 424,                          // $@54
        S_hooks_libraries_list = 425,            // hooks_libraries_list
        S_not_empty_hooks_libraries_list = 426,  // not_empty_hooks_libraries_list
        S_hooks_library = 427,                   // hooks_library
        S_428_55 = 428,                          // $@55
        S_sub_hooks_library = 429,               // sub_hooks_library
        S_430_56 = 430,                          // $@56
        S_hooks_params = 431,                    // hooks_params
        S_hooks_param = 432,                     // hooks_param
        S_library = 433,                         // library
        S_434_57 = 434,                          // $@57
        S_parameters = 435,                      // parameters
        S_436_58 = 436,                          // $@58
        S_expired_leases_processing = 437,       // expired_leases_processing
        S_438_59 = 438,                          // $@59
        S_expired_leases_params = 439,           // expired_leases_params
        S_expired_leases_param = 440,            // expired_leases_param
        S_reclaim_timer_wait_time = 441,         // reclaim_timer_wait_time
        S_flush_reclaimed_timer_wait_time = 442, // flush_reclaimed_timer_wait_time
        S_hold_reclaimed_time = 443,             // hold_reclaimed_time
        S_max_reclaim_leases = 444,              // max_reclaim_leases
        S_max_reclaim_time = 445,                // max_reclaim_time
        S_unwarned_reclaim_cycles = 446,         // unwarned_reclaim_cycles
        S_subnet4_list = 447,                    // subnet4_list
        S_448_60 = 448,                          // $@60
        S_subnet4_list_content = 449,            // subnet4_list_content
        S_not_empty_subnet4_list = 450,          // not_empty_subnet4_list
        S_subnet4 = 451,                         // subnet4
        S_452_61 = 452,                          // $@61
        S_sub_subnet4 = 453,                     // sub_subnet4
        S_454_62 = 454,                          // $@62
        S_subnet4_params = 455,                  // subnet4_params
        S_subnet4_param = 456,                   // subnet4_param
        S_subnet = 457,                          // subnet
        S_458_63 = 458,                          // $@63
        S_subnet_4o6_interface = 459,            // subnet_4o6_interface
        S_460_64 = 460,                          // $@64
        S_subnet_4o6_interface_id = 461,         // subnet_4o6_interface_id
        S_462_65 = 462,                          // $@65
        S_subnet_4o6_subnet = 463,               // subnet_4o6_subnet
        S_464_66 = 464,                          // $@66
        ...
        S_id = 478,                              // id
        S_shared_networks = 479,                 // shared_networks
        S_480_72 = 480,                          // $@72
        S_shared_networks_content = 481,         // shared_networks_content
        S_shared_networks_list = 482,            // shared_networks_list
        S_shared_network = 483,                  // shared_network
        S_484_73 = 484,                          // $@73
        S_shared_network_params = 485,           // shared_network_params
        S_shared_network_param = 486,            // shared_network_param
        S_option_def_list = 487,                 // option_def_list
        S_488_74 = 488,                          // $@74
        S_sub_option_def_list = 489,             // sub_option_def_list
        S_490_75 = 490,                          // $@75
        S_option_def_list_content = 491,         // option_def_list_content
        S_not_empty_option_def_list = 492,       // not_empty_option_def_list
        S_option_def_entry = 493,                // option_def_entry
        S_494_76 = 494,                          // $@76
        S_sub_option_def = 495,                  // sub_option_def
        S_496_77 = 496,                          // $@77
        S_option_def_params = 497,               // option_def_params
        S_not_empty_option_def_params = 498,     // not_empty_option_def_params
        S_option_def_param = 499,                // option_def_param
        S_option_def_name = 500,                 // option_def_name
        S_code = 501,                            // code
        S_option_def_code = 502,                 // option_def_code
        S_option_def_type = 503,                 // option_def_type
        S_504_78 = 504,                          // $@78
        S_option_def_record_types = 505,         // option_def_record_types
        S_506_79 = 506,                          // $@79
        S_space = 507,                           // space
        S_508_80 = 508,                          // $@80
        S_option_def_space = 509,                // option_def_space
        S_option_def_encapsulate = 510,          // option_def_encapsulate
        S_511_81 = 511,                          // $@81
        S_option_def_array = 512,                // option_def_array
        S_option_data_list = 513,                // option_data_list
        S_514_82 = 514,                          // $@82
        S_option_data_list_content = 515,        // option_data_list_content
        S_not_empty_option_data_list = 516,      // not_empty_option_data_list
        S_option_data_entry = 517,               // option_data_entry
        S_518_83 = 518,                          // $@83
        S_sub_option_data = 519,                 // sub_option_data
        S_520_84 = 520,                          // $@84
        S_option_data_params = 521,              // option_data_params
        S_not_empty_option_data_params = 522,    // not_empty_option_data_params
        S_option_data_param = 523,               // option_data_param
        S_option_data_name = 524,                // option_data_name
        S_option_data_data = 525,                // option_data_data
        S_526_85 = 526,                          // $@85
        S_option_data_code = 527,                // option_data_code
        S_option_data_space = 528,               // option_data_space
        S_option_data_csv_format = 529,          // option_data_csv_format
        S_option_data_always_send = 530,         // option_data_always_send
        S_option_data_never_send = 531,          // option_data_never_send
        S_option_data_client_classes = 532,      // option_data_client_classes
        S_533_86 = 533,                          // $@86
        S_pools_list = 534,                      // pools_list
        S_535_87 = 535,                          // $@87
        S_pools_list_content = 536,              // pools_list_content
        S_not_empty_pools_list = 537,            // not_empty_pools_list
        S_pool_list_entry = 538,                 // pool_list_entry
        S_539_88 = 539,                          // $@88
        S_sub_pool4 = 540,                       // sub_pool4
        S_541_89 = 541,                          // $@89
        S_pool_params = 542,                     // pool_params
        S_pool_param = 543,                      // pool_param
        S_pool_entry = 544,                      // pool_entry
        S_545_90 = 545,                          // $@90
        S_pool_id = 546,                         // pool_id
        S_user_context = 547,                    // user_context
        S_548_91 = 548,                          // $@91
        S_comment = 549,                         // comment
        S_550_92 = 550,                          // $@92
        ...
        S_next_server = 562,                     // next_server
        S_563_96 = 563,                          // $@96
        S_server_hostname = 564,                 // server_hostname
        S_565_97 = 565,                          // $@97
        S_boot_file_name = 566,                  // boot_file_name
        S_567_98 = 567,                          // $@98
        S_ip_address = 568,                      // ip_address
        S_569_99 = 569,                          // $@99
        S_duid = 570,                            // duid
        S_571_100 = 571,                         // $@100
        S_hw_address = 572,                      // hw_address
        S_573_101 = 573,                         // $@101
        S_client_id_value = 574,                 // client_id_value
        S_575_102 = 575,                         // $@102
        S_circuit_id_value = 576,                // circuit_id_value
        S_577_103 = 577,                         // $@103
        S_flex_id_value = 578,                   // flex_id_value
        S_579_104 = 579,                         // $@104
        S_hostname = 580,                        // hostname
        S_581_105 = 581,                         // $@105
        S_reservation_client_classes = 582,      // reservation_client_classes
        S_583_106 = 583,                         // $@106
        S_relay = 584,                           // relay
        S_585_107 = 585,                         // $@107
        S_relay_map = 586,                       // relay_map
        S_ip_addresses = 587,                    // ip_addresses
        S_588_108 = 588,                         // $@108
        ...
        S_dhcp4o6_port = 605,                    // dhcp4o6_port
        S_control_socket = 606,                  // control_socket
        S_607_113 = 607,                         // $@113
        S_control_sockets = 608,                 // control_sockets
        S_609_114 = 609,                         // $@114
        S_control_socket_list = 610,             // control_socket_list
        S_not_empty_control_socket_list = 611,   // not_empty_control_socket_list
        S_control_socket_entry = 612,            // control_socket_entry
        S_613_115 = 613,                         // $@115
        S_control_socket_params = 614,           // control_socket_params
        S_control_socket_param = 615,            // control_socket_param
        S_control_socket_type = 616,             // control_socket_type
        S_617_116 = 617,                         // $@116
        S_control_socket_type_value = 618,       // control_socket_type_value
        S_control_socket_name = 619,             // control_socket_name
        S_620_117 = 620,                         // $@117
        S_control_socket_address = 621,          // control_socket_address
        S_622_118 = 622,                         // $@118
        S_control_socket_port = 623,             // control_socket_port
        S_cert_required = 624,                   // cert_required
        S_http_headers = 625,                    // http_headers
        S_626_119 = 626,                         // $@119
        S_http_header_list = 627,                // http_header_list
        S_not_empty_http_header_list = 628,      // not_empty_http_header_list
        S_http_header = 629,                     // http_header
        S_630_120 = 630,                         // $@120
        S_http_header_params = 631,              // http_header_params
        S_http_header_param = 632,               // http_header_param
        S_header_value = 633,                    // header_value
        S_634_121 = 634,                         // $@121
        S_authentication = 635,                  // authentication
        S_636_122 = 636,                         // $@122
        S_auth_params = 637,                     // auth_params
        S_auth_param = 638,                      // auth_param
        S_auth_type = 639,                       // auth_type
        S_640_123 = 640,                         // $@123
        S_auth_type_value = 641,                 // auth_type_value
        S_realm = 642,                           // realm
        S_643_124 = 643,                         // $@124
        S_directory = 644,                       // directory
        S_645_125 = 645,                         // $@125
        S_clients = 646,                         // clients
        S_647_126 = 647,                         // $@126
        S_clients_list = 648,                    // clients_list
        S_not_empty_clients_list = 649,          // not_empty_clients_list
        S_basic_auth = 650,                      // basic_auth
        S_651_127 = 651,                         // $@127
        S_clients_params = 652,                  // clients_params
        S_clients_param = 653,                   // clients_param
        S_user_file = 654,                       // user_file
        S_655_128 = 655,                         // $@128
...
switch (yykind)
  ...
  private:
    ...
    enum
    {
      yylast_ = 1661,     ///< Last index in yytable_.
