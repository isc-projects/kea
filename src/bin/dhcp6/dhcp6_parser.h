  ...
  private:
    ...
    struct token
    {
      enum yytokentype
      {
        ...
        TOKEN_ENABLE_RECONFIGURATION = 312,
        TOKEN_SUBNET6 = 313,
...
switch (yytype)
  ...
  private:
    ...
    {
      yyeof_ = 0,
      yylast_ = 1111,     ///< Last index in yytable_.
