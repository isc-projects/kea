  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_374_42 = 374,                          // $@42
        S_password_file = 375,                   // password_file
        S_376_43 = 376,                          // $@43
        S_host = 377,                            // host
        S_378_44 = 378,                          // $@44
        S_port = 379,                            // port
        S_name = 380,                            // name
        S_381_45 = 381,                          // $@45
        S_persist = 382,                         // persist
        S_lfc_interval = 383,                    // lfc_interval
        S_readonly = 384,                        // readonly
        S_connect_timeout = 385,                 // connect_timeout
        S_read_timeout = 386,                    // read_timeout
        S_write_timeout = 387,                   // write_timeout
        S_tcp_user_timeout = 388,                // tcp_user_timeout
        S_max_reconnect_tries = 389,             // max_reconnect_tries
        S_reconnect_wait_time = 390,             // reconnect_wait_time
        S_on_fail = 391,                         // on_fail
        S_392_46 = 392,                          // $@46
        S_on_fail_mode = 393,                    // on_fail_mode
        S_retry_on_startup = 394,                // retry_on_startup
        S_max_row_errors = 395,                  // max_row_errors
        S_trust_anchor = 396,                    // trust_anchor
        S_397_47 = 397,                          // $@47
        S_cert_file = 398,                       // cert_file
        S_399_48 = 399,                          // $@48
        S_key_file = 400,                        // key_file
        S_401_49 = 401,                          // $@49
        ...
        S_not_empty_classes_list = 591,          // not_empty_classes_list
        ...
        S_dhcp4o6_port = 604,                    // dhcp4o6_port
...
switch (yykind)
  ...
  private:
    ...
    enum
    {
      yylast_ = 1596,     ///< Last index in yytable_.
