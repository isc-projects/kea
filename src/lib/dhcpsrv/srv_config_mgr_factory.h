...
#ifndef SRV_CONFIG_MGR_FACTORY_H
#define SRV_CONFIG_MGR_FACTORY_H
...
class NoServerConfigManager : public Exception {
public:
    NoServerConfigManager(const char* file, size_t line, const char* what)
...
public:
    ...
    /// configuration
    /// is returned by the "instance" method.
    ///
    ...
    /// server configuration manager is available.
    static void destroy();
...
private:
    ...
    static boost::scoped_ptr<SrvConfigMgr>& getConfigurationMgrPtr();
};
