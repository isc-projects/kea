...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    TOKEN_ALLOW_ADDRESS_REGISTRATION = 471, // "allow-address-registration"
    TOKEN_LOGGERS = 472,           // "loggers"
    TOKEN_OUTPUT_OPTIONS = 473,    // "output-options"
    TOKEN_OUTPUT = 474,            // "output"
    TOKEN_DEBUGLEVEL = 475,        // "debuglevel"
    TOKEN_SEVERITY = 476,          // "severity"
    TOKEN_FLUSH = 477,             // "flush"
    TOKEN_MAXSIZE = 478,           // "maxsize"
    TOKEN_MAXVER = 479,            // "maxver"
    TOKEN_PATTERN = 480,           // "pattern"
    TOKEN_COMPATIBILITY = 481,     // "compatibility"
    TOKEN_LENIENT_OPTION_PARSING = 482, // "lenient-option-parsing"
    TOKEN_TOPLEVEL_JSON = 483,     // TOPLEVEL_JSON
    TOKEN_TOPLEVEL_DHCP6 = 484,    // TOPLEVEL_DHCP6
    TOKEN_SUB_DHCP6 = 485,         // SUB_DHCP6
    TOKEN_SUB_INTERFACES6 = 486,   // SUB_INTERFACES6
    TOKEN_SUB_SUBNET6 = 487,       // SUB_SUBNET6
    TOKEN_SUB_POOL6 = 488,         // SUB_POOL6
    TOKEN_SUB_PD_POOL = 489,       // SUB_PD_POOL
    TOKEN_SUB_RESERVATION = 490,   // SUB_RESERVATION
    TOKEN_SUB_OPTION_DEFS = 491,   // SUB_OPTION_DEFS
    TOKEN_SUB_OPTION_DEF = 492,    // SUB_OPTION_DEF
    TOKEN_SUB_OPTION_DATA = 493,   // SUB_OPTION_DATA
    TOKEN_SUB_HOOKS_LIBRARY = 494, // SUB_HOOKS_LIBRARY
    TOKEN_SUB_DHCP_DDNS = 495,     // SUB_DHCP_DDNS
    TOKEN_SUB_CONFIG_CONTROL = 496, // SUB_CONFIG_CONTROL
    TOKEN_STRING = 497,            // "constant string"
    TOKEN_INTEGER = 498,           // "integer"
    TOKEN_FLOAT = 499,             // "floating point"
    TOKEN_BOOLEAN = 500            // "boolean"
      };
    ...
    struct symbol_kind
    {
      ...
      {
        YYNTOKENS = 246, ///< Number of tokens.
        S_YYEMPTY = -2,
        ...
        S_ALLOW_ADDRESS_REGISTRATION = 216,      // "allow-address-registration"
        S_LOGGERS = 217,                         // "loggers"
        S_OUTPUT_OPTIONS = 218,                  // "output-options"
        S_OUTPUT = 219,                          // "output"
        S_DEBUGLEVEL = 220,                      // "debuglevel"
        S_SEVERITY = 221,                        // "severity"
        S_FLUSH = 222,                           // "flush"
        S_MAXSIZE = 223,                         // "maxsize"
        S_MAXVER = 224,                          // "maxver"
        S_PATTERN = 225,                         // "pattern"
        S_COMPATIBILITY = 226,                   // "compatibility"
        S_LENIENT_OPTION_PARSING = 227,          // "lenient-option-parsing"
        S_TOPLEVEL_JSON = 228,                   // TOPLEVEL_JSON
        S_TOPLEVEL_DHCP6 = 229,                  // TOPLEVEL_DHCP6
        S_SUB_DHCP6 = 230,                       // SUB_DHCP6
        S_SUB_INTERFACES6 = 231,                 // SUB_INTERFACES6
        S_SUB_SUBNET6 = 232,                     // SUB_SUBNET6
        S_SUB_POOL6 = 233,                       // SUB_POOL6
        S_SUB_PD_POOL = 234,                     // SUB_PD_POOL
        S_SUB_RESERVATION = 235,                 // SUB_RESERVATION
        S_SUB_OPTION_DEFS = 236,                 // SUB_OPTION_DEFS
        S_SUB_OPTION_DEF = 237,                  // SUB_OPTION_DEF
        S_SUB_OPTION_DATA = 238,                 // SUB_OPTION_DATA
        S_SUB_HOOKS_LIBRARY = 239,               // SUB_HOOKS_LIBRARY
        S_SUB_DHCP_DDNS = 240,                   // SUB_DHCP_DDNS
        S_SUB_CONFIG_CONTROL = 241,              // SUB_CONFIG_CONTROL
        S_STRING = 242,                          // "constant string"
        S_INTEGER = 243,                         // "integer"
        S_FLOAT = 244,                           // "floating point"
        S_BOOLEAN = 245,                         // "boolean"
        S_YYACCEPT = 246,                        // $accept
        S_start = 247,                           // start
        S_248_1 = 248,                           // $@1
        S_249_2 = 249,                           // $@2
        S_250_3 = 250,                           // $@3
        ...
        S_261_14 = 261,                          // $@14
        S_value = 262,                           // value
        S_sub_json = 263,                        // sub_json
        S_map2 = 264,                            // map2
        S_265_15 = 265,                          // $@15
        S_map_value = 266,                       // map_value
        S_map_content = 267,                     // map_content
        S_not_empty_map = 268,                   // not_empty_map
        S_list_generic = 269,                    // list_generic
        S_270_16 = 270,                          // $@16
        S_list_content = 271,                    // list_content
        S_not_empty_list = 272,                  // not_empty_list
        S_list_strings = 273,                    // list_strings
        S_274_17 = 274,                          // $@17
        S_list_strings_content = 275,            // list_strings_content
        S_not_empty_list_strings = 276,          // not_empty_list_strings
        S_unknown_map_entry = 277,               // unknown_map_entry
        S_syntax_map = 278,                      // syntax_map
        S_279_18 = 279,                          // $@18
        S_global_object = 280,                   // global_object
        S_281_19 = 281,                          // $@19
        S_global_object_comma = 282,             // global_object_comma
        S_sub_dhcp6 = 283,                       // sub_dhcp6
        S_284_20 = 284,                          // $@20
        S_global_params = 285,                   // global_params
        S_global_param = 286,                    // global_param
        S_data_directory = 287,                  // data_directory
        S_288_21 = 288,                          // $@21
        S_preferred_lifetime = 289,              // preferred_lifetime
        S_min_preferred_lifetime = 290,          // min_preferred_lifetime
        S_max_preferred_lifetime = 291,          // max_preferred_lifetime
        S_valid_lifetime = 292,                  // valid_lifetime
        S_min_valid_lifetime = 293,              // min_valid_lifetime
        S_max_valid_lifetime = 294,              // max_valid_lifetime
        S_renew_timer = 295,                     // renew_timer
        S_rebind_timer = 296,                    // rebind_timer
        S_calculate_tee_times = 297,             // calculate_tee_times
        S_t1_percent = 298,                      // t1_percent
        S_t2_percent = 299,                      // t2_percent
        S_cache_threshold = 300,                 // cache_threshold
        S_cache_max_age = 301,                   // cache_max_age
        S_adaptive_lease_time_threshold = 302,   // adaptive_lease_time_threshold
        S_decline_probation_period = 303,        // decline_probation_period
        S_ddns_send_updates = 304,               // ddns_send_updates
        S_ddns_override_no_update = 305,         // ddns_override_no_update
        S_ddns_override_client_update = 306,     // ddns_override_client_update
        S_ddns_replace_client_name = 307,        // ddns_replace_client_name
        S_308_22 = 308,                          // $@22
        S_ddns_replace_client_name_value = 309,  // ddns_replace_client_name_value
        S_ddns_generated_prefix = 310,           // ddns_generated_prefix
        S_311_23 = 311,                          // $@23
        S_ddns_qualifying_suffix = 312,          // ddns_qualifying_suffix
        S_313_24 = 313,                          // $@24
        S_ddns_update_on_renew = 314,            // ddns_update_on_renew
        S_ddns_use_conflict_resolution = 315,    // ddns_use_conflict_resolution
        S_ddns_conflict_resolution_mode = 316,   // ddns_conflict_resolution_mode
        S_317_25 = 317,                          // $@25
        S_ddns_conflict_resolution_mode_value = 318, // ddns_conflict_resolution_mode_value
        S_ddns_ttl_percent = 319,                // ddns_ttl_percent
        S_ddns_ttl = 320,                        // ddns_ttl
        S_ddns_ttl_min = 321,                    // ddns_ttl_min
        S_ddns_ttl_max = 322,                    // ddns_ttl_max
        S_hostname_char_set = 323,               // hostname_char_set
        S_324_26 = 324,                          // $@26
        S_hostname_char_replacement = 325,       // hostname_char_replacement
        S_326_27 = 326,                          // $@27
        S_store_extended_info = 327,             // store_extended_info
        S_statistic_default_sample_count = 328,  // statistic_default_sample_count
        S_statistic_default_sample_age = 329,    // statistic_default_sample_age
        S_server_tag = 330,                      // server_tag
        S_331_28 = 331,                          // $@28
        S_parked_packet_limit = 332,             // parked_packet_limit
        S_allocator = 333,                       // allocator
        S_334_29 = 334,                          // $@29
        S_pd_allocator = 335,                    // pd_allocator
        S_336_30 = 336,                          // $@30
        S_early_global_reservations_lookup = 337, // early_global_reservations_lookup
        S_ip_reservations_unique = 338,          // ip_reservations_unique
        S_reservations_lookup_first = 339,       // reservations_lookup_first
        S_allow_address_registration = 340,      // allow_address_registration
        S_interfaces_config = 341,               // interfaces_config
        S_342_31 = 342,                          // $@31
        S_sub_interfaces6 = 343,                 // sub_interfaces6
        S_344_32 = 344,                          // $@32
        S_interfaces_config_params = 345,        // interfaces_config_params
        S_interfaces_config_param = 346,         // interfaces_config_param
        S_interfaces_list = 347,                 // interfaces_list
        S_348_33 = 348,                          // $@33
        S_re_detect = 349,                       // re_detect
        S_service_sockets_require_all = 350,     // service_sockets_require_all
        S_service_sockets_retry_wait_time = 351, // service_sockets_retry_wait_time
        S_service_sockets_max_retries = 352,     // service_sockets_max_retries
        S_lease_database = 353,                  // lease_database
        S_354_34 = 354,                          // $@34
        S_hosts_database = 355,                  // hosts_database
        S_356_35 = 356,                          // $@35
        S_hosts_databases = 357,                 // hosts_databases
        S_358_36 = 358,                          // $@36
        S_database_list = 359,                   // database_list
        S_not_empty_database_list = 360,         // not_empty_database_list
        S_database = 361,                        // database
        S_362_37 = 362,                          // $@37
        S_database_map_params = 363,             // database_map_params
        S_database_map_param = 364,              // database_map_param
        S_database_type = 365,                   // database_type
        S_366_38 = 366,                          // $@38
        S_user = 367,                            // user
        S_368_39 = 368,                          // $@39
        S_password = 369,                        // password
        S_370_40 = 370,                          // $@40
        S_password_file = 371,                   // password_file
        S_372_41 = 372,                          // $@41
        S_host = 373,                            // host
        S_374_42 = 374,                          // $@42
        S_port = 375,                            // port
        S_name = 376,                            // name
        S_377_43 = 377,                          // $@43
        S_persist = 378,                         // persist
        S_lfc_interval = 379,                    // lfc_interval
        S_readonly = 380,                        // readonly
        S_connect_timeout = 381,                 // connect_timeout
        S_read_timeout = 382,                    // read_timeout
        S_write_timeout = 383,                   // write_timeout
        S_tcp_user_timeout = 384,                // tcp_user_timeout
        S_reconnect_wait_time = 385,             // reconnect_wait_time
        S_on_fail = 386,                         // on_fail
        S_387_44 = 387,                          // $@44
        S_on_fail_mode = 388,                    // on_fail_mode
        S_retry_on_startup = 389,                // retry_on_startup
        S_max_row_errors = 390,                  // max_row_errors
        S_max_reconnect_tries = 391,             // max_reconnect_tries
        S_trust_anchor = 392,                    // trust_anchor
        S_393_45 = 393,                          // $@45
        S_cert_file = 394,                       // cert_file
        S_395_46 = 395,                          // $@46
        S_key_file = 396,                        // key_file
        S_397_47 = 397,                          // $@47
        S_ssl_mode = 398,                        // ssl_mode
        S_399_48 = 399,                          // $@48
        S_cipher_list = 400,                     // cipher_list
        S_401_49 = 401,                          // $@49
        S_sanity_checks = 402,                   // sanity_checks
        S_403_50 = 403,                          // $@50
        S_sanity_checks_params = 404,            // sanity_checks_params
        S_sanity_checks_param = 405,             // sanity_checks_param
        S_lease_checks = 406,                    // lease_checks
        S_407_51 = 407,                          // $@51
        S_extended_info_checks = 408,            // extended_info_checks
        S_409_52 = 409,                          // $@52
        S_mac_sources = 410,                     // mac_sources
        S_411_53 = 411,                          // $@53
        S_mac_sources_list = 412,                // mac_sources_list
        S_mac_sources_value = 413,               // mac_sources_value
        S_duid_id = 414,                         // duid_id
        S_string_id = 415,                       // string_id
        S_host_reservation_identifiers = 416,    // host_reservation_identifiers
        S_417_54 = 417,                          // $@54
        S_host_reservation_identifiers_list = 418, // host_reservation_identifiers_list
        S_host_reservation_identifier = 419,     // host_reservation_identifier
        S_hw_address_id = 420,                   // hw_address_id
        S_flex_id = 421,                         // flex_id
        S_relay_supplied_options = 422,          // relay_supplied_options
        S_423_55 = 423,                          // $@55
        S_dhcp_multi_threading = 424,            // dhcp_multi_threading
        S_425_56 = 425,                          // $@56
        S_multi_threading_params = 426,          // multi_threading_params
        S_multi_threading_param = 427,           // multi_threading_param
        S_enable_multi_threading = 428,          // enable_multi_threading
        S_thread_pool_size = 429,                // thread_pool_size
        S_packet_queue_size = 430,               // packet_queue_size
        S_hooks_libraries = 431,                 // hooks_libraries
        S_432_57 = 432,                          // $@57
        S_hooks_libraries_list = 433,            // hooks_libraries_list
        S_not_empty_hooks_libraries_list = 434,  // not_empty_hooks_libraries_list
        S_hooks_library = 435,                   // hooks_library
        S_436_58 = 436,                          // $@58
        S_sub_hooks_library = 437,               // sub_hooks_library
        S_438_59 = 438,                          // $@59
        S_hooks_params = 439,                    // hooks_params
        S_hooks_param = 440,                     // hooks_param
        S_library = 441,                         // library
        S_442_60 = 442,                          // $@60
        S_parameters = 443,                      // parameters
        S_444_61 = 444,                          // $@61
        S_expired_leases_processing = 445,       // expired_leases_processing
        S_446_62 = 446,                          // $@62
        S_expired_leases_params = 447,           // expired_leases_params
        S_expired_leases_param = 448,            // expired_leases_param
        S_reclaim_timer_wait_time = 449,         // reclaim_timer_wait_time
        S_flush_reclaimed_timer_wait_time = 450, // flush_reclaimed_timer_wait_time
        S_hold_reclaimed_time = 451,             // hold_reclaimed_time
        S_max_reclaim_leases = 452,              // max_reclaim_leases
        S_max_reclaim_time = 453,                // max_reclaim_time
        S_unwarned_reclaim_cycles = 454,         // unwarned_reclaim_cycles
        S_subnet6_list = 455,                    // subnet6_list
        S_456_63 = 456,                          // $@63
        S_subnet6_list_content = 457,            // subnet6_list_content
        S_not_empty_subnet6_list = 458,          // not_empty_subnet6_list
        S_subnet6 = 459,                         // subnet6
        S_460_64 = 460,                          // $@64
        S_sub_subnet6 = 461,                     // sub_subnet6
        S_462_65 = 462,                          // $@65
        S_subnet6_params = 463,                  // subnet6_params
        S_subnet6_param = 464,                   // subnet6_param
        S_subnet = 465,                          // subnet
        S_466_66 = 466,                          // $@66
        S_interface = 467,                       // interface
        S_468_67 = 468,                          // $@67
        S_interface_id = 469,                    // interface_id
        S_470_68 = 470,                          // $@68
        S_client_class = 471,                    // client_class
        S_472_69 = 472,                          // $@69
        S_network_client_classes = 473,          // network_client_classes
        S_474_70 = 474,                          // $@70
        S_require_client_classes = 475,          // require_client_classes
        S_476_71 = 476,                          // $@71
        S_evaluate_additional_classes = 477,     // evaluate_additional_classes
        S_478_72 = 478,                          // $@72
        S_reservations_global = 479,             // reservations_global
        S_reservations_in_subnet = 480,          // reservations_in_subnet
        S_reservations_out_of_pool = 481,        // reservations_out_of_pool
        S_id = 482,                              // id
        S_rapid_commit = 483,                    // rapid_commit
        S_shared_networks = 484,                 // shared_networks
        S_485_73 = 485,                          // $@73
        S_shared_networks_content = 486,         // shared_networks_content
        S_shared_networks_list = 487,            // shared_networks_list
        S_shared_network = 488,                  // shared_network
        S_489_74 = 489,                          // $@74
        S_shared_network_params = 490,           // shared_network_params
        S_shared_network_param = 491,            // shared_network_param
        S_option_def_list = 492,                 // option_def_list
        S_493_75 = 493,                          // $@75
        S_sub_option_def_list = 494,             // sub_option_def_list
        S_495_76 = 495,                          // $@76
        S_option_def_list_content = 496,         // option_def_list_content
        S_not_empty_option_def_list = 497,       // not_empty_option_def_list
        S_option_def_entry = 498,                // option_def_entry
        S_499_77 = 499,                          // $@77
        S_sub_option_def = 500,                  // sub_option_def
        S_501_78 = 501,                          // $@78
        S_option_def_params = 502,               // option_def_params
        S_not_empty_option_def_params = 503,     // not_empty_option_def_params
        S_option_def_param = 504,                // option_def_param
        S_option_def_name = 505,                 // option_def_name
        S_code = 506,                            // code
        S_option_def_code = 507,                 // option_def_code
        S_option_def_type = 508,                 // option_def_type
        S_509_79 = 509,                          // $@79
        S_option_def_record_types = 510,         // option_def_record_types
        S_511_80 = 511,                          // $@80
        S_space = 512,                           // space
        S_513_81 = 513,                          // $@81
        S_option_def_space = 514,                // option_def_space
        S_option_def_encapsulate = 515,          // option_def_encapsulate
        S_516_82 = 516,                          // $@82
        S_option_def_array = 517,                // option_def_array
        S_option_data_list = 518,                // option_data_list
        S_519_83 = 519,                          // $@83
        S_option_data_list_content = 520,        // option_data_list_content
        S_not_empty_option_data_list = 521,      // not_empty_option_data_list
        S_option_data_entry = 522,               // option_data_entry
        S_523_84 = 523,                          // $@84
        S_sub_option_data = 524,                 // sub_option_data
        S_525_85 = 525,                          // $@85
        S_option_data_params = 526,              // option_data_params
        S_not_empty_option_data_params = 527,    // not_empty_option_data_params
        S_option_data_param = 528,               // option_data_param
        S_option_data_name = 529,                // option_data_name
        S_option_data_data = 530,                // option_data_data
        S_531_86 = 531,                          // $@86
        S_option_data_code = 532,                // option_data_code
        S_option_data_space = 533,               // option_data_space
        S_option_data_csv_format = 534,          // option_data_csv_format
        S_option_data_always_send = 535,         // option_data_always_send
        S_option_data_never_send = 536,          // option_data_never_send
        S_option_data_client_classes = 537,      // option_data_client_classes
        S_538_87 = 538,                          // $@87
        S_pools_list = 539,                      // pools_list
        S_540_88 = 540,                          // $@88
        S_pools_list_content = 541,              // pools_list_content
        S_not_empty_pools_list = 542,            // not_empty_pools_list
        S_pool_list_entry = 543,                 // pool_list_entry
        S_544_89 = 544,                          // $@89
        S_sub_pool6 = 545,                       // sub_pool6
        S_546_90 = 546,                          // $@90
        S_pool_params = 547,                     // pool_params
        S_pool_param = 548,                      // pool_param
        S_pool_entry = 549,                      // pool_entry
        S_550_91 = 550,                          // $@91
        S_pool_id = 551,                         // pool_id
        S_user_context = 552,                    // user_context
        S_553_92 = 553,                          // $@92
        S_comment = 554,                         // comment
        S_555_93 = 555,                          // $@93
        S_pd_pools_list = 556,                   // pd_pools_list
        S_557_94 = 557,                          // $@94
        S_pd_pools_list_content = 558,           // pd_pools_list_content
        S_not_empty_pd_pools_list = 559,         // not_empty_pd_pools_list
        S_pd_pool_entry = 560,                   // pd_pool_entry
        S_561_95 = 561,                          // $@95
        S_sub_pd_pool = 562,                     // sub_pd_pool
        S_563_96 = 563,                          // $@96
        S_pd_pool_params = 564,                  // pd_pool_params
        S_pd_pool_param = 565,                   // pd_pool_param
        S_pd_prefix = 566,                       // pd_prefix
        S_567_97 = 567,                          // $@97
        S_pd_prefix_len = 568,                   // pd_prefix_len
        S_excluded_prefix = 569,                 // excluded_prefix
        S_570_98 = 570,                          // $@98
        S_excluded_prefix_len = 571,             // excluded_prefix_len
        S_pd_delegated_len = 572,                // pd_delegated_len
        S_reservations = 573,                    // reservations
        S_574_99 = 574,                          // $@99
        S_reservations_list = 575,               // reservations_list
        S_not_empty_reservations_list = 576,     // not_empty_reservations_list
        S_reservation = 577,                     // reservation
        S_578_100 = 578,                         // $@100
        S_sub_reservation = 579,                 // sub_reservation
        S_580_101 = 580,                         // $@101
        S_reservation_params = 581,              // reservation_params
        S_not_empty_reservation_params = 582,    // not_empty_reservation_params
        S_reservation_param = 583,               // reservation_param
        S_ip_addresses = 584,                    // ip_addresses
        S_585_102 = 585,                         // $@102
        S_prefixes = 586,                        // prefixes
        S_587_103 = 587,                         // $@103
        S_excluded_prefixes = 588,               // excluded_prefixes
        S_589_104 = 589,                         // $@104
        S_duid = 590,                            // duid
        S_591_105 = 591,                         // $@105
        S_hw_address = 592,                      // hw_address
        S_593_106 = 593,                         // $@106
        S_hostname = 594,                        // hostname
        S_595_107 = 595,                         // $@107
        S_flex_id_value = 596,                   // flex_id_value
        S_597_108 = 597,                         // $@108
        S_reservation_client_classes = 598,      // reservation_client_classes
        S_599_109 = 599,                         // $@109
        S_relay = 600,                           // relay
        S_601_110 = 601,                         // $@110
        S_relay_map = 602,                       // relay_map
        S_client_classes = 603,                  // client_classes
        S_604_111 = 604,                         // $@111
        S_client_classes_list = 605,             // client_classes_list
        S_not_empty_classes_list = 606,          // not_empty_classes_list
        S_client_class_entry = 607,              // client_class_entry
        S_608_112 = 608,                         // $@112
        S_client_class_params = 609,             // client_class_params
        S_not_empty_client_class_params = 610,   // not_empty_client_class_params
        S_client_class_param = 611,              // client_class_param
        S_client_class_name = 612,               // client_class_name
        S_client_class_test = 613,               // client_class_test
        S_614_113 = 614,                         // $@113
        S_client_class_template_test = 615,      // client_class_template_test
        S_616_114 = 616,                         // $@114
        S_only_if_required = 617,                // only_if_required
        S_only_in_additional_list = 618,         // only_in_additional_list
        S_server_id = 619,                       // server_id
        S_620_115 = 620,                         // $@115
        S_server_id_params = 621,                // server_id_params
        S_server_id_param = 622,                 // server_id_param
        S_server_id_type = 623,                  // server_id_type
        S_624_116 = 624,                         // $@116
        S_duid_type = 625,                       // duid_type
        S_htype = 626,                           // htype
        S_identifier = 627,                      // identifier
        S_628_117 = 628,                         // $@117
        S_time = 629,                            // time
        S_enterprise_id = 630,                   // enterprise_id
        S_dhcp4o6_port = 631,                    // dhcp4o6_port
        S_control_socket = 632,                  // control_socket
        S_633_118 = 633,                         // $@118
        S_control_sockets = 634,                 // control_sockets
        S_635_119 = 635,                         // $@119
        S_control_socket_list = 636,             // control_socket_list
        S_not_empty_control_socket_list = 637,   // not_empty_control_socket_list
        S_control_socket_entry = 638,            // control_socket_entry
        S_639_120 = 639,                         // $@120
        S_control_socket_params = 640,           // control_socket_params
        S_control_socket_param = 641,            // control_socket_param
        S_control_socket_type = 642,             // control_socket_type
        S_643_121 = 643,                         // $@121
        S_control_socket_type_value = 644,       // control_socket_type_value
        S_control_socket_name = 645,             // control_socket_name
        S_646_122 = 646,                         // $@122
        S_control_socket_address = 647,          // control_socket_address
        S_648_123 = 648,                         // $@123
        S_control_socket_port = 649,             // control_socket_port
        S_cert_required = 650,                   // cert_required
        S_http_headers = 651,                    // http_headers
        S_652_124 = 652,                         // $@124
        S_http_header_list = 653,                // http_header_list
        S_not_empty_http_header_list = 654,      // not_empty_http_header_list
        S_http_header = 655,                     // http_header
        S_656_125 = 656,                         // $@125
        S_http_header_params = 657,              // http_header_params
        S_http_header_param = 658,               // http_header_param
        S_header_value = 659,                    // header_value
        S_660_126 = 660,                         // $@126
        S_authentication = 661,                  // authentication
        S_662_127 = 662,                         // $@127
        S_auth_params = 663,                     // auth_params
        S_auth_param = 664,                      // auth_param
        S_auth_type = 665,                       // auth_type
        S_666_128 = 666,                         // $@128
        S_auth_type_value = 667,                 // auth_type_value
        S_realm = 668,                           // realm
        S_669_129 = 669,                         // $@129
        S_directory = 670,                       // directory
        S_671_130 = 671,                         // $@130
        S_clients = 672,                         // clients
        S_673_131 = 673,                         // $@131
        S_clients_list = 674,                    // clients_list
        S_not_empty_clients_list = 675,          // not_empty_clients_list
        S_basic_auth = 676,                      // basic_auth
        S_677_132 = 677,                         // $@132
        S_clients_params = 678,                  // clients_params
        S_clients_param = 679,                   // clients_param
        S_user_file = 680,                       // user_file
        S_681_133 = 681,                         // $@133
...
switch (yykind)
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_ALLOW_ADDRESS_REGISTRATION (location_type l)
      {
        return symbol_type (token::TOKEN_ALLOW_ADDRESS_REGISTRATION, std::move (l));
      }
#else
      static
      symbol_type
      make_ALLOW_ADDRESS_REGISTRATION (const location_type& l)
      {
        return symbol_type (token::TOKEN_ALLOW_ADDRESS_REGISTRATION, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
