  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_name = 373,                            // name
        S_374_42 = 374,                          // $@42
        S_persist = 375,                         // persist
        S_lfc_interval = 376,                    // lfc_interval
        S_readonly = 377,                        // readonly
        S_connect_timeout = 378,                 // connect_timeout
        S_read_timeout = 379,                    // read_timeout
        S_write_timeout = 380,                   // write_timeout
        S_tcp_user_timeout = 381,                // tcp_user_timeout
        ...
        S_trust_anchor = 389,                    // trust_anchor
        S_390_44 = 390,                          // $@44
        S_cert_file = 391,                       // cert_file
        S_392_45 = 392,                          // $@45
        S_key_file = 393,                        // key_file
        S_394_46 = 394,                          // $@46
        ...
        S_not_empty_classes_list = 603,          // not_empty_classes_list
...
switch (yykind)
  ...
  private:
    ...
    enum
    {
      yylast_ = 1756,     ///< Last index in yytable_.
