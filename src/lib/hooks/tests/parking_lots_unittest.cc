...
TEST(ParkingLotsTest, createGetParkingLot) {
    ...
    EXPECT_EQ(0U, parking_lot0->size());
    EXPECT_EQ(0U, parking_lot1->size());
    EXPECT_EQ(0U, parking_lot2->size());
