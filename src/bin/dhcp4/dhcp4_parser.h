...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    TOKEN_TEST = 378,              // "test"
    TOKEN_ONLY_IF_REQUIRED = 379,  // "only-if-required"
    TOKEN_CLIENT_CLASS = 380,      // "client-class"
    TOKEN_RESERVATIONS = 381,      // "reservations"
    TOKEN_DUID = 382,              // "duid"
    TOKEN_HW_ADDRESS = 383,        // "hw-address"
    TOKEN_CIRCUIT_ID = 384,        // "circuit-id"
    TOKEN_CLIENT_ID = 385,         // "client-id"
    TOKEN_HOSTNAME = 386,          // "hostname"
    TOKEN_FLEX_ID = 387,           // "flex-id"
    TOKEN_RELAY = 388,             // "relay"
    ...
    TOKEN_DHCP4O6_PORT = 401,      // "dhcp4o6-port"
    TOKEN_DHCP_MULTI_THREADING = 402, // "multi-threading"
    TOKEN_ENABLE_MULTI_THREADING = 403, // "enable-multi-threading"
    TOKEN_THREAD_POOL_SIZE = 404,  // "thread-pool-size"
    TOKEN_PACKET_QUEUE_SIZE = 405, // "packet-queue-size"
    TOKEN_CONTROL_SOCKET = 406,    // "control-socket"
    TOKEN_SOCKET_TYPE = 407,       // "socket-type"
    TOKEN_SOCKET_NAME = 408,       // "socket-name"
    TOKEN_DHCP_QUEUE_CONTROL = 409, // "dhcp-queue-control"
    TOKEN_ENABLE_QUEUE = 410,      // "enable-queue"
    TOKEN_QUEUE_TYPE = 411,        // "queue-type"
    TOKEN_CAPACITY = 412,          // "capacity"
    TOKEN_DHCP_DDNS = 413,         // "dhcp-ddns"
    TOKEN_ENABLE_UPDATES = 414,    // "enable-updates"
    TOKEN_QUALIFYING_SUFFIX = 415, // "qualifying-suffix"
    TOKEN_SERVER_IP = 416,         // "server-ip"
    TOKEN_SERVER_PORT = 417,       // "server-port"
    TOKEN_SENDER_IP = 418,         // "sender-ip"
    TOKEN_SENDER_PORT = 419,       // "sender-port"
    TOKEN_MAX_QUEUE_SIZE = 420,    // "max-queue-size"
    TOKEN_NCR_PROTOCOL = 421,      // "ncr-protocol"
    TOKEN_NCR_FORMAT = 422,        // "ncr-format"
    TOKEN_OVERRIDE_NO_UPDATE = 423, // "override-no-update"
    TOKEN_OVERRIDE_CLIENT_UPDATE = 424, // "override-client-update"
    TOKEN_REPLACE_CLIENT_NAME = 425, // "replace-client-name"
    TOKEN_GENERATED_PREFIX = 426,  // "generated-prefix"
    TOKEN_TCP = 427,               // "tcp"
    TOKEN_JSON = 428,              // "JSON"
    TOKEN_WHEN_PRESENT = 429,      // "when-present"
    TOKEN_NEVER = 430,             // "never"
    TOKEN_ALWAYS = 431,            // "always"
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_TEST = 123,                            // "test"
        S_ONLY_IF_REQUIRED = 124,                // "only-if-required"
        S_CLIENT_CLASS = 125,                    // "client-class"
        S_RESERVATIONS = 126,                    // "reservations"
        S_DUID = 127,                            // "duid"
        S_HW_ADDRESS = 128,                      // "hw-address"
        S_CIRCUIT_ID = 129,                      // "circuit-id"
        S_CLIENT_ID = 130,                       // "client-id"
        S_HOSTNAME = 131,                        // "hostname"
        S_FLEX_ID = 132,                         // "flex-id"
        S_RELAY = 133,                           // "relay"
        ...
        S_DHCP4O6_PORT = 146,                    // "dhcp4o6-port"
        S_DHCP_MULTI_THREADING = 147,            // "multi-threading"
        S_ENABLE_MULTI_THREADING = 148,          // "enable-multi-threading"
        S_THREAD_POOL_SIZE = 149,                // "thread-pool-size"
        S_PACKET_QUEUE_SIZE = 150,               // "packet-queue-size"
        S_CONTROL_SOCKET = 151,                  // "control-socket"
        S_SOCKET_TYPE = 152,                     // "socket-type"
        S_SOCKET_NAME = 153,                     // "socket-name"
        S_DHCP_QUEUE_CONTROL = 154,              // "dhcp-queue-control"
        S_ENABLE_QUEUE = 155,                    // "enable-queue"
        S_QUEUE_TYPE = 156,                      // "queue-type"
        S_CAPACITY = 157,                        // "capacity"
        S_DHCP_DDNS = 158,                       // "dhcp-ddns"
        S_ENABLE_UPDATES = 159,                  // "enable-updates"
        S_QUALIFYING_SUFFIX = 160,               // "qualifying-suffix"
        S_SERVER_IP = 161,                       // "server-ip"
        S_SERVER_PORT = 162,                     // "server-port"
        S_SENDER_IP = 163,                       // "sender-ip"
        S_SENDER_PORT = 164,                     // "sender-port"
        S_MAX_QUEUE_SIZE = 165,                  // "max-queue-size"
        S_NCR_PROTOCOL = 166,                    // "ncr-protocol"
        S_NCR_FORMAT = 167,                      // "ncr-format"
        S_OVERRIDE_NO_UPDATE = 168,              // "override-no-update"
        S_OVERRIDE_CLIENT_UPDATE = 169,          // "override-client-update"
        S_REPLACE_CLIENT_NAME = 170,             // "replace-client-name"
        S_GENERATED_PREFIX = 171,                // "generated-prefix"
        S_TCP = 172,                             // "tcp"
        S_JSON = 173,                            // "JSON"
        S_WHEN_PRESENT = 174,                    // "when-present"
        S_NEVER = 175,                           // "never"
        S_ALWAYS = 176,                          // "always"
        ...
        S_302_31 = 302,                          // $@31
        S_sanity_checks = 303,                   // sanity_checks
        S_304_32 = 304,                          // $@32
        S_sanity_checks_params = 305,            // sanity_checks_params
        S_sanity_checks_param = 306,             // sanity_checks_param
        S_lease_checks = 307,                    // lease_checks
        S_308_33 = 308,                          // $@33
        S_hosts_database = 309,                  // hosts_database
        S_310_34 = 310,                          // $@34
        S_hosts_databases = 311,                 // hosts_databases
        S_312_35 = 312,                          // $@35
        S_database_list = 313,                   // database_list
        S_not_empty_database_list = 314,         // not_empty_database_list
        S_database = 315,                        // database
        S_316_36 = 316,                          // $@36
        S_database_map_params = 317,             // database_map_params
        S_database_map_param = 318,              // database_map_param
        S_database_type = 319,                   // database_type
        S_320_37 = 320,                          // $@37
        S_db_type = 321,                         // db_type
        S_user = 322,                            // user
        S_323_38 = 323,                          // $@38
        S_password = 324,                        // password
        S_325_39 = 325,                          // $@39
        S_host = 326,                            // host
        S_327_40 = 327,                          // $@40
        S_port = 328,                            // port
        S_name = 329,                            // name
        S_330_41 = 330,                          // $@41
        S_persist = 331,                         // persist
        S_lfc_interval = 332,                    // lfc_interval
        S_readonly = 333,                        // readonly
        S_connect_timeout = 334,                 // connect_timeout
        ...
        S_reconnect_wait_time = 347,             // reconnect_wait_time
        S_on_fail = 348,                         // on_fail
        S_349_46 = 349,                          // $@46
        S_on_fail_mode = 350,                    // on_fail_mode
        S_max_row_errors = 351,                  // max_row_errors
        S_trust_anchor = 352,                    // trust_anchor
        S_353_47 = 353,                          // $@47
        S_cert_file = 354,                       // cert_file
        S_355_48 = 355,                          // $@48
        S_key_file = 356,                        // key_file
        S_357_49 = 357,                          // $@49
        S_cipher_list = 358,                     // cipher_list
        S_359_50 = 359,                          // $@50
        S_host_reservation_identifiers = 360,    // host_reservation_identifiers
        S_361_51 = 361,                          // $@51
        S_host_reservation_identifiers_list = 362, // host_reservation_identifiers_list
        S_host_reservation_identifier = 363,     // host_reservation_identifier
        S_duid_id = 364,                         // duid_id
        S_hw_address_id = 365,                   // hw_address_id
        S_circuit_id = 366,                      // circuit_id
        S_client_id = 367,                       // client_id
        S_flex_id = 368,                         // flex_id
        S_dhcp_multi_threading = 369,            // dhcp_multi_threading
        S_370_52 = 370,                          // $@52
        S_multi_threading_params = 371,          // multi_threading_params
        S_multi_threading_param = 372,           // multi_threading_param
        S_enable_multi_threading = 373,          // enable_multi_threading
        S_thread_pool_size = 374,                // thread_pool_size
        S_packet_queue_size = 375,               // packet_queue_size
        S_hooks_libraries = 376,                 // hooks_libraries
        S_377_53 = 377,                          // $@53
        S_hooks_libraries_list = 378,            // hooks_libraries_list
        S_not_empty_hooks_libraries_list = 379,  // not_empty_hooks_libraries_list
        S_hooks_library = 380,                   // hooks_library
        S_381_54 = 381,                          // $@54
        S_sub_hooks_library = 382,               // sub_hooks_library
        S_383_55 = 383,                          // $@55
        S_hooks_params = 384,                    // hooks_params
        S_hooks_param = 385,                     // hooks_param
        S_library = 386,                         // library
        S_387_56 = 387,                          // $@56
        S_parameters = 388,                      // parameters
        S_389_57 = 389,                          // $@57
        S_expired_leases_processing = 390,       // expired_leases_processing
        S_391_58 = 391,                          // $@58
        S_expired_leases_params = 392,           // expired_leases_params
        S_expired_leases_param = 393,            // expired_leases_param
        S_reclaim_timer_wait_time = 394,         // reclaim_timer_wait_time
        S_flush_reclaimed_timer_wait_time = 395, // flush_reclaimed_timer_wait_time
        S_hold_reclaimed_time = 396,             // hold_reclaimed_time
        S_max_reclaim_leases = 397,              // max_reclaim_leases
        S_max_reclaim_time = 398,                // max_reclaim_time
        S_unwarned_reclaim_cycles = 399,         // unwarned_reclaim_cycles
        S_subnet4_list = 400,                    // subnet4_list
        S_401_59 = 401,                          // $@59
        S_subnet4_list_content = 402,            // subnet4_list_content
        S_not_empty_subnet4_list = 403,          // not_empty_subnet4_list
        S_subnet4 = 404,                         // subnet4
        S_405_60 = 405,                          // $@60
        S_sub_subnet4 = 406,                     // sub_subnet4
        S_407_61 = 407,                          // $@61
        S_subnet4_params = 408,                  // subnet4_params
        S_subnet4_param = 409,                   // subnet4_param
        S_subnet = 410,                          // subnet
        S_411_62 = 411,                          // $@62
        S_subnet_4o6_interface = 412,            // subnet_4o6_interface
        S_413_63 = 413,                          // $@63
        S_subnet_4o6_interface_id = 414,         // subnet_4o6_interface_id
        S_415_64 = 415,                          // $@64
        S_subnet_4o6_subnet = 416,               // subnet_4o6_subnet
        S_417_65 = 417,                          // $@65
        ...
        S_id = 430,                              // id
        S_shared_networks = 431,                 // shared_networks
        S_432_70 = 432,                          // $@70
        S_shared_networks_content = 433,         // shared_networks_content
        S_shared_networks_list = 434,            // shared_networks_list
        S_shared_network = 435,                  // shared_network
        S_436_71 = 436,                          // $@71
        S_shared_network_params = 437,           // shared_network_params
        S_shared_network_param = 438,            // shared_network_param
        S_option_def_list = 439,                 // option_def_list
        S_440_72 = 440,                          // $@72
        S_sub_option_def_list = 441,             // sub_option_def_list
        S_442_73 = 442,                          // $@73
        S_option_def_list_content = 443,         // option_def_list_content
        S_not_empty_option_def_list = 444,       // not_empty_option_def_list
        S_option_def_entry = 445,                // option_def_entry
        S_446_74 = 446,                          // $@74
        S_sub_option_def = 447,                  // sub_option_def
        S_448_75 = 448,                          // $@75
        S_option_def_params = 449,               // option_def_params
        S_not_empty_option_def_params = 450,     // not_empty_option_def_params
        S_option_def_param = 451,                // option_def_param
        S_option_def_name = 452,                 // option_def_name
        S_code = 453,                            // code
        S_option_def_code = 454,                 // option_def_code
        S_option_def_type = 455,                 // option_def_type
        S_456_76 = 456,                          // $@76
        S_option_def_record_types = 457,         // option_def_record_types
        S_458_77 = 458,                          // $@77
        S_space = 459,                           // space
        S_460_78 = 460,                          // $@78
        S_option_def_space = 461,                // option_def_space
        S_option_def_encapsulate = 462,          // option_def_encapsulate
        S_463_79 = 463,                          // $@79
        S_option_def_array = 464,                // option_def_array
        S_option_data_list = 465,                // option_data_list
        S_466_80 = 466,                          // $@80
        S_option_data_list_content = 467,        // option_data_list_content
        S_not_empty_option_data_list = 468,      // not_empty_option_data_list
        S_option_data_entry = 469,               // option_data_entry
        S_470_81 = 470,                          // $@81
        S_sub_option_data = 471,                 // sub_option_data
        S_472_82 = 472,                          // $@82
        S_option_data_params = 473,              // option_data_params
        S_not_empty_option_data_params = 474,    // not_empty_option_data_params
        S_option_data_param = 475,               // option_data_param
        S_option_data_name = 476,                // option_data_name
        S_option_data_data = 477,                // option_data_data
        S_478_83 = 478,                          // $@83
        S_option_data_code = 479,                // option_data_code
        S_option_data_space = 480,               // option_data_space
        S_option_data_csv_format = 481,          // option_data_csv_format
        S_option_data_always_send = 482,         // option_data_always_send
        S_pools_list = 483,                      // pools_list
        S_484_84 = 484,                          // $@84
        S_pools_list_content = 485,              // pools_list_content
        S_not_empty_pools_list = 486,            // not_empty_pools_list
        S_pool_list_entry = 487,                 // pool_list_entry
        S_488_85 = 488,                          // $@85
        S_sub_pool4 = 489,                       // sub_pool4
        S_490_86 = 490,                          // $@86
        S_pool_params = 491,                     // pool_params
        S_pool_param = 492,                      // pool_param
        S_pool_entry = 493,                      // pool_entry
        S_494_87 = 494,                          // $@87
        S_user_context = 495,                    // user_context
        S_496_88 = 496,                          // $@88
        S_comment = 497,                         // comment
        S_498_89 = 498,                          // $@89
        ...
        S_next_server = 510,                     // next_server
        S_511_93 = 511,                          // $@93
        S_server_hostname = 512,                 // server_hostname
        S_513_94 = 513,                          // $@94
        S_boot_file_name = 514,                  // boot_file_name
        S_515_95 = 515,                          // $@95
        S_ip_address = 516,                      // ip_address
        S_517_96 = 517,                          // $@96
        S_ip_addresses = 518,                    // ip_addresses
        S_519_97 = 519,                          // $@97
        S_duid = 520,                            // duid
        S_521_98 = 521,                          // $@98
        S_hw_address = 522,                      // hw_address
        S_523_99 = 523,                          // $@99
        S_client_id_value = 524,                 // client_id_value
        S_525_100 = 525,                         // $@100
        S_circuit_id_value = 526,                // circuit_id_value
        S_527_101 = 527,                         // $@101
        S_flex_id_value = 528,                   // flex_id_value
        S_529_102 = 529,                         // $@102
        S_hostname = 530,                        // hostname
        S_531_103 = 531,                         // $@103
        S_reservation_client_classes = 532,      // reservation_client_classes
        S_533_104 = 533,                         // $@104
        S_relay = 534,                           // relay
        S_535_105 = 535,                         // $@105
        S_relay_map = 536,                       // relay_map
        S_client_classes = 537,                  // client_classes
        S_538_106 = 538,                         // $@106
        S_client_classes_list = 539,             // client_classes_list
        S_client_class_entry = 540,              // client_class_entry
        S_541_107 = 541,                         // $@107
        S_client_class_params = 542,             // client_class_params
        S_not_empty_client_class_params = 543,   // not_empty_client_class_params
        S_client_class_param = 544,              // client_class_param
        S_client_class_name = 545,               // client_class_name
        S_client_class_test = 546,               // client_class_test
        S_547_108 = 547,                         // $@108
...
switch (yykind)
  ...
  private:
    ...
    enum
    {
      yylast_ = 1275,     ///< Last index in yytable_.
