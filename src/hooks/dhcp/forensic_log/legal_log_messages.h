...
extern const isc::log::MessageID LEGAL_LOG_COMMAND_NO_LEGAL_STORE;
...
extern const isc::log::MessageID LEGAL_LOG_INVALID_ACCESS;
...
extern const isc::log::MessageID LEGAL_LOG_MYSQL_DB;
...
extern const isc::log::MessageID LEGAL_LOG_PGSQL_DB;
