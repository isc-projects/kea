...
extern const isc::log::MessageID HOSTS_CFG_UPDATE_ADD;
extern const isc::log::MessageID HOSTS_CFG_UPDATE_DEL4;
extern const isc::log::MessageID HOSTS_CFG_UPDATE_DEL6;
