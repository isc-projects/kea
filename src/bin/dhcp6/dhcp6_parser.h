...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    TOKEN_EXCLUDED_PREFIXES = 389, // "excluded-prefixes"
    TOKEN_DUID = 390,              // "duid"
    TOKEN_HW_ADDRESS = 391,        // "hw-address"
    TOKEN_HOSTNAME = 392,          // "hostname"
    TOKEN_FLEX_ID = 393,           // "flex-id"
    TOKEN_RELAY = 394,             // "relay"
    ...
    TOKEN_SERVER_ID = 405,         // "server-id"
    TOKEN_LLT = 406,               // "LLT"
    TOKEN_EN = 407,                // "EN"
    TOKEN_LL = 408,                // "LL"
    TOKEN_IDENTIFIER = 409,        // "identifier"
    TOKEN_HTYPE = 410,             // "htype"
    TOKEN_TIME = 411,              // "time"
    TOKEN_ENTERPRISE_ID = 412,     // "enterprise-id"
    ...
    TOKEN_CONTROL_SOCKETS = 419,   // "control-sockets"
    TOKEN_SOCKET_TYPE = 420,       // "socket-type"
    TOKEN_UNIX = 421,              // "unix"
    TOKEN_HTTP = 422,              // "http"
    TOKEN_HTTPS = 423,             // "https"
    TOKEN_SOCKET_NAME = 424,       // "socket-name"
    TOKEN_SOCKET_ADDRESS = 425,    // "socket-address"
    TOKEN_SOCKET_PORT = 426,       // "socket-port"
    TOKEN_AUTHENTICATION = 427,    // "authentication"
    TOKEN_BASIC = 428,             // "basic"
    TOKEN_REALM = 429,             // "realm"
    TOKEN_DIRECTORY = 430,         // "directory"
    TOKEN_CLIENTS = 431,           // "clients"
    TOKEN_USER_FILE = 432,         // "user-file"
    TOKEN_PASSWORD_FILE = 433,     // "password-file"
    TOKEN_CERT_REQUIRED = 434,     // "cert-required"
    ...
    TOKEN_TCP = 449,               // "TCP"
    TOKEN_JSON = 450,              // "JSON"
    TOKEN_WHEN_PRESENT = 451,      // "when-present"
    TOKEN_NEVER = 452,             // "never"
    TOKEN_ALWAYS = 453,            // "always"
    TOKEN_WHEN_NOT_PRESENT = 454,  // "when-not-present"
    TOKEN_HOSTNAME_CHAR_SET = 455, // "hostname-char-set"
    TOKEN_HOSTNAME_CHAR_REPLACEMENT = 456, // "hostname-char-replacement"
    TOKEN_EARLY_GLOBAL_RESERVATIONS_LOOKUP = 457, // "early-global-reservations-lookup"
    TOKEN_IP_RESERVATIONS_UNIQUE = 458, // "ip-reservations-unique"
    TOKEN_RESERVATIONS_LOOKUP_FIRST = 459, // "reservations-lookup-first"
    TOKEN_LOGGERS = 460,           // "loggers"
    TOKEN_OUTPUT_OPTIONS = 461,    // "output-options"
    TOKEN_OUTPUT = 462,            // "output"
    TOKEN_DEBUGLEVEL = 463,        // "debuglevel"
    TOKEN_SEVERITY = 464,          // "severity"
    TOKEN_FLUSH = 465,             // "flush"
    TOKEN_MAXSIZE = 466,           // "maxsize"
    TOKEN_MAXVER = 467,            // "maxver"
    TOKEN_PATTERN = 468,           // "pattern"
    TOKEN_COMPATIBILITY = 469,     // "compatibility"
    TOKEN_LENIENT_OPTION_PARSING = 470, // "lenient-option-parsing"
    TOKEN_TOPLEVEL_JSON = 471,     // TOPLEVEL_JSON
    TOKEN_TOPLEVEL_DHCP6 = 472,    // TOPLEVEL_DHCP6
    TOKEN_SUB_DHCP6 = 473,         // SUB_DHCP6
    TOKEN_SUB_INTERFACES6 = 474,   // SUB_INTERFACES6
    TOKEN_SUB_SUBNET6 = 475,       // SUB_SUBNET6
    TOKEN_SUB_POOL6 = 476,         // SUB_POOL6
    TOKEN_SUB_PD_POOL = 477,       // SUB_PD_POOL
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_EXCLUDED_PREFIXES = 134,               // "excluded-prefixes"
        S_DUID = 135,                            // "duid"
        S_HW_ADDRESS = 136,                      // "hw-address"
        S_HOSTNAME = 137,                        // "hostname"
        S_FLEX_ID = 138,                         // "flex-id"
        S_RELAY = 139,                           // "relay"
        ...
        S_SERVER_ID = 150,                       // "server-id"
        S_LLT = 151,                             // "LLT"
        S_EN = 152,                              // "EN"
        S_LL = 153,                              // "LL"
        S_IDENTIFIER = 154,                      // "identifier"
        S_HTYPE = 155,                           // "htype"
        S_TIME = 156,                            // "time"
        S_ENTERPRISE_ID = 157,                   // "enterprise-id"
        ...
        S_CONTROL_SOCKETS = 164,                 // "control-sockets"
        S_SOCKET_TYPE = 165,                     // "socket-type"
        S_UNIX = 166,                            // "unix"
        S_HTTP = 167,                            // "http"
        S_HTTPS = 168,                           // "https"
        S_SOCKET_NAME = 169,                     // "socket-name"
        S_SOCKET_ADDRESS = 170,                  // "socket-address"
        S_SOCKET_PORT = 171,                     // "socket-port"
        S_AUTHENTICATION = 172,                  // "authentication"
        S_BASIC = 173,                           // "basic"
        S_REALM = 174,                           // "realm"
        S_DIRECTORY = 175,                       // "directory"
        S_CLIENTS = 176,                         // "clients"
        S_USER_FILE = 177,                       // "user-file"
        S_PASSWORD_FILE = 178,                   // "password-file"
        S_CERT_REQUIRED = 179,                   // "cert-required"
        ...
        S_TCP = 194,                             // "TCP"
        S_JSON = 195,                            // "JSON"
        S_WHEN_PRESENT = 196,                    // "when-present"
        S_NEVER = 197,                           // "never"
        S_ALWAYS = 198,                          // "always"
        S_WHEN_NOT_PRESENT = 199,                // "when-not-present"
        S_HOSTNAME_CHAR_SET = 200,               // "hostname-char-set"
        S_HOSTNAME_CHAR_REPLACEMENT = 201,       // "hostname-char-replacement"
        S_EARLY_GLOBAL_RESERVATIONS_LOOKUP = 202, // "early-global-reservations-lookup"
        S_IP_RESERVATIONS_UNIQUE = 203,          // "ip-reservations-unique"
        S_RESERVATIONS_LOOKUP_FIRST = 204,       // "reservations-lookup-first"
        S_LOGGERS = 205,                         // "loggers"
        S_OUTPUT_OPTIONS = 206,                  // "output-options"
        S_OUTPUT = 207,                          // "output"
        S_DEBUGLEVEL = 208,                      // "debuglevel"
        S_SEVERITY = 209,                        // "severity"
        S_FLUSH = 210,                           // "flush"
        S_MAXSIZE = 211,                         // "maxsize"
        S_MAXVER = 212,                          // "maxver"
        S_PATTERN = 213,                         // "pattern"
        S_COMPATIBILITY = 214,                   // "compatibility"
        S_LENIENT_OPTION_PARSING = 215,          // "lenient-option-parsing"
        S_TOPLEVEL_JSON = 216,                   // TOPLEVEL_JSON
        S_TOPLEVEL_DHCP6 = 217,                  // TOPLEVEL_DHCP6
        S_SUB_DHCP6 = 218,                       // SUB_DHCP6
        S_SUB_INTERFACES6 = 219,                 // SUB_INTERFACES6
        S_SUB_SUBNET6 = 220,                     // SUB_SUBNET6
        S_SUB_POOL6 = 221,                       // SUB_POOL6
        S_SUB_PD_POOL = 222,                     // SUB_PD_POOL
        ...
        S_sub_dhcp6 = 271,                       // sub_dhcp6
        S_272_20 = 272,                          // $@20
        S_global_params = 273,                   // global_params
        S_global_param = 274,                    // global_param
        S_data_directory = 275,                  // data_directory
        S_276_21 = 276,                          // $@21
        S_preferred_lifetime = 277,              // preferred_lifetime
        S_min_preferred_lifetime = 278,          // min_preferred_lifetime
        S_max_preferred_lifetime = 279,          // max_preferred_lifetime
        ...
        S_ddns_send_updates = 291,               // ddns_send_updates
        S_ddns_override_no_update = 292,         // ddns_override_no_update
        S_ddns_override_client_update = 293,     // ddns_override_client_update
        S_ddns_replace_client_name = 294,        // ddns_replace_client_name
        S_295_22 = 295,                          // $@22
        S_ddns_replace_client_name_value = 296,  // ddns_replace_client_name_value
        S_ddns_generated_prefix = 297,           // ddns_generated_prefix
        S_298_23 = 298,                          // $@23
        S_ddns_qualifying_suffix = 299,          // ddns_qualifying_suffix
        S_300_24 = 300,                          // $@24
        S_ddns_update_on_renew = 301,            // ddns_update_on_renew
        S_ddns_use_conflict_resolution = 302,    // ddns_use_conflict_resolution
        S_ddns_conflict_resolution_mode = 303,   // ddns_conflict_resolution_mode
        S_304_25 = 304,                          // $@25
        S_ddns_conflict_resolution_mode_value = 305, // ddns_conflict_resolution_mode_value
        S_ddns_ttl_percent = 306,                // ddns_ttl_percent
        S_hostname_char_set = 307,               // hostname_char_set
        S_308_26 = 308,                          // $@26
        S_hostname_char_replacement = 309,       // hostname_char_replacement
        S_310_27 = 310,                          // $@27
        S_store_extended_info = 311,             // store_extended_info
        S_statistic_default_sample_count = 312,  // statistic_default_sample_count
        S_statistic_default_sample_age = 313,    // statistic_default_sample_age
        S_server_tag = 314,                      // server_tag
        S_315_28 = 315,                          // $@28
        S_parked_packet_limit = 316,             // parked_packet_limit
        S_allocator = 317,                       // allocator
        S_318_29 = 318,                          // $@29
        S_pd_allocator = 319,                    // pd_allocator
        S_320_30 = 320,                          // $@30
        S_early_global_reservations_lookup = 321, // early_global_reservations_lookup
        S_ip_reservations_unique = 322,          // ip_reservations_unique
        S_reservations_lookup_first = 323,       // reservations_lookup_first
        S_interfaces_config = 324,               // interfaces_config
        S_325_31 = 325,                          // $@31
        S_sub_interfaces6 = 326,                 // sub_interfaces6
        S_327_32 = 327,                          // $@32
        S_interfaces_config_params = 328,        // interfaces_config_params
        S_interfaces_config_param = 329,         // interfaces_config_param
        ...
        S_pools_list = 513,                      // pools_list
        S_514_83 = 514,                          // $@83
        S_pools_list_content = 515,              // pools_list_content
        S_not_empty_pools_list = 516,            // not_empty_pools_list
        S_pool_list_entry = 517,                 // pool_list_entry
        S_518_84 = 518,                          // $@84
        S_sub_pool6 = 519,                       // sub_pool6
        S_520_85 = 520,                          // $@85
        S_pool_params = 521,                     // pool_params
        S_pool_param = 522,                      // pool_param
        S_pool_entry = 523,                      // pool_entry
        S_524_86 = 524,                          // $@86
        S_pool_id = 525,                         // pool_id
        S_user_context = 526,                    // user_context
        S_527_87 = 527,                          // $@87
        S_comment = 528,                         // comment
        S_529_88 = 529,                          // $@88
        S_pd_pools_list = 530,                   // pd_pools_list
        S_531_89 = 531,                          // $@89
        S_pd_pools_list_content = 532,           // pd_pools_list_content
        S_not_empty_pd_pools_list = 533,         // not_empty_pd_pools_list
        S_pd_pool_entry = 534,                   // pd_pool_entry
        S_535_90 = 535,                          // $@90
        S_sub_pd_pool = 536,                     // sub_pd_pool
        S_537_91 = 537,                          // $@91
        S_pd_pool_params = 538,                  // pd_pool_params
        S_pd_pool_param = 539,                   // pd_pool_param
        S_pd_prefix = 540,                       // pd_prefix
        S_541_92 = 541,                          // $@92
        S_pd_prefix_len = 542,                   // pd_prefix_len
        S_excluded_prefix = 543,                 // excluded_prefix
        S_544_93 = 544,                          // $@93
        S_excluded_prefix_len = 545,             // excluded_prefix_len
        S_pd_delegated_len = 546,                // pd_delegated_len
        ...
        S_ip_addresses = 558,                    // ip_addresses
        S_559_97 = 559,                          // $@97
        S_prefixes = 560,                        // prefixes
        S_561_98 = 561,                          // $@98
        S_excluded_prefixes = 562,               // excluded_prefixes
        S_563_99 = 563,                          // $@99
        S_duid = 564,                            // duid
        S_565_100 = 565,                         // $@100
        S_hw_address = 566,                      // hw_address
        S_567_101 = 567,                         // $@101
        S_hostname = 568,                        // hostname
        S_569_102 = 569,                         // $@102
        S_flex_id_value = 570,                   // flex_id_value
        S_571_103 = 571,                         // $@103
        S_reservation_client_classes = 572,      // reservation_client_classes
        S_573_104 = 573,                         // $@104
        S_relay = 574,                           // relay
        S_575_105 = 575,                         // $@105
        S_relay_map = 576,                       // relay_map
        ...
        S_server_id = 591,                       // server_id
        S_592_110 = 592,                         // $@110
        S_server_id_params = 593,                // server_id_params
        S_server_id_param = 594,                 // server_id_param
        S_server_id_type = 595,                  // server_id_type
        S_596_111 = 596,                         // $@111
        S_duid_type = 597,                       // duid_type
        S_htype = 598,                           // htype
        S_identifier = 599,                      // identifier
        S_600_112 = 600,                         // $@112
        S_time = 601,                            // time
        S_enterprise_id = 602,                   // enterprise_id
        ...
        S_authentication = 623,                  // authentication
        S_624_119 = 624,                         // $@119
        S_auth_params = 625,                     // auth_params
        S_auth_param = 626,                      // auth_param
        S_auth_type = 627,                       // auth_type
        S_628_120 = 628,                         // $@120
        S_auth_type_value = 629,                 // auth_type_value
        S_realm = 630,                           // realm
        S_631_121 = 631,                         // $@121
        S_directory = 632,                       // directory
        S_633_122 = 633,                         // $@122
        S_clients = 634,                         // clients
        S_635_123 = 635,                         // $@123
        S_clients_list = 636,                    // clients_list
        S_not_empty_clients_list = 637,          // not_empty_clients_list
        S_basic_auth = 638,                      // basic_auth
        S_639_124 = 639,                         // $@124
        S_clients_params = 640,                  // clients_params
        S_clients_param = 641,                   // clients_param
        S_user_file = 642,                       // user_file
        S_643_125 = 643,                         // $@125
        S_password_file = 644,                   // password_file
        S_645_126 = 645,                         // $@126
        S_dhcp_queue_control = 646,              // dhcp_queue_control
        S_647_127 = 647,                         // $@127
        S_queue_control_params = 648,            // queue_control_params
        S_queue_control_param = 649,             // queue_control_param
        S_enable_queue = 650,                    // enable_queue
        S_queue_type = 651,                      // queue_type
        S_652_128 = 652,                         // $@128
        S_capacity = 653,                        // capacity
        S_arbitrary_map_entry = 654,             // arbitrary_map_entry
        S_655_129 = 655,                         // $@129
        S_dhcp_ddns = 656,                       // dhcp_ddns
        S_657_130 = 657,                         // $@130
        S_sub_dhcp_ddns = 658,                   // sub_dhcp_ddns
        S_659_131 = 659,                         // $@131
        S_dhcp_ddns_params = 660,                // dhcp_ddns_params
        S_dhcp_ddns_param = 661,                 // dhcp_ddns_param
        S_enable_updates = 662,                  // enable_updates
        S_server_ip = 663,                       // server_ip
        S_664_132 = 664,                         // $@132
        S_server_port = 665,                     // server_port
        S_sender_ip = 666,                       // sender_ip
        S_667_133 = 667,                         // $@133
        S_sender_port = 668,                     // sender_port
        S_max_queue_size = 669,                  // max_queue_size
        S_ncr_protocol = 670,                    // ncr_protocol
        S_671_134 = 671,                         // $@134
        S_ncr_protocol_value = 672,              // ncr_protocol_value
        S_ncr_format = 673,                      // ncr_format
        S_674_135 = 674,                         // $@135
        S_config_control = 675,                  // config_control
        S_676_136 = 676,                         // $@136
        S_sub_config_control = 677,              // sub_config_control
        S_678_137 = 678,                         // $@137
        S_config_control_params = 679,           // config_control_params
        S_config_control_param = 680,            // config_control_param
        S_config_databases = 681,                // config_databases
        S_682_138 = 682,                         // $@138
        S_config_fetch_wait_time = 683,          // config_fetch_wait_time
        S_loggers = 684,                         // loggers
        S_685_139 = 685,                         // $@139
        S_loggers_entries = 686,                 // loggers_entries
        S_logger_entry = 687,                    // logger_entry
        S_688_140 = 688,                         // $@140
        S_logger_params = 689,                   // logger_params
        S_logger_param = 690,                    // logger_param
        S_debuglevel = 691,                      // debuglevel
        S_severity = 692,                        // severity
        S_693_141 = 693,                         // $@141
        S_output_options_list = 694,             // output_options_list
        S_695_142 = 695,                         // $@142
        S_output_options_list_content = 696,     // output_options_list_content
        S_output_entry = 697,                    // output_entry
        S_698_143 = 698,                         // $@143
        S_output_params_list = 699,              // output_params_list
        S_output_params = 700,                   // output_params
        S_output = 701,                          // output
        S_702_144 = 702,                         // $@144
        S_flush = 703,                           // flush
        S_maxsize = 704,                         // maxsize
        S_maxver = 705,                          // maxver
        S_pattern = 706,                         // pattern
        S_707_145 = 707,                         // $@145
        S_compatibility = 708,                   // compatibility
        S_709_146 = 709,                         // $@146
        S_compatibility_params = 710,            // compatibility_params
        S_compatibility_param = 711,             // compatibility_param
        S_lenient_option_parsing = 712           // lenient_option_parsing
      };
    };
...
switch (yykind)
  ...
  private:
    ...
    enum
    {
      yylast_ = 1573,     ///< Last index in yytable_.
      yynnts_ = 479,  ///< Number of nonterminal symbols.
