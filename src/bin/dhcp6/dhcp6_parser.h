  ...
  private:
    ...
    struct token
    {
      enum yytokentype
      {
        ...
        TOKEN_MAX_ROW_ERRORS = 292,
        TOKEN_PREFERRED_LIFETIME = 293,
        ...
        TOKEN_ALWAYS_SEND = 306,
        TOKEN_RECORD_TYPES = 307,
        TOKEN_ENCAPSULATE = 308,
        TOKEN_ARRAY = 309,
        TOKEN_POOLS = 310,
        TOKEN_POOL = 311,
        TOKEN_PD_POOLS = 312,
        TOKEN_PREFIX = 313,
        TOKEN_PREFIX_LEN = 314,
        TOKEN_EXCLUDED_PREFIX = 315,
        TOKEN_EXCLUDED_PREFIX_LEN = 316,
        TOKEN_DELEGATED_LEN = 317,
        TOKEN_USER_CONTEXT = 318,
        TOKEN_COMMENT = 319,
        TOKEN_SUBNET = 320,
        TOKEN_INTERFACE = 321,
        ...
        TOKEN_REQUIRE_CLIENT_CLASSES = 334,
        TOKEN_TEST = 335,
        TOKEN_ONLY_IF_REQUIRED = 336,
        TOKEN_CLIENT_CLASS = 337,
        TOKEN_RESERVATIONS = 338,
        TOKEN_IP_ADDRESSES = 339,
        TOKEN_PREFIXES = 340,
        TOKEN_DUID = 341,
        ...
        TOKEN_EN = 359,
        TOKEN_LL = 360,
        TOKEN_IDENTIFIER = 361,
        TOKEN_HTYPE = 362,
        TOKEN_TIME = 363,
        TOKEN_ENTERPRISE_ID = 364,
        ...
        TOKEN_TOPLEVEL_DHCP6 = 404,
        TOKEN_SUB_DHCP6 = 405,
        TOKEN_SUB_INTERFACES6 = 406,
        TOKEN_SUB_SUBNET6 = 407,
        TOKEN_SUB_POOL6 = 408,
        TOKEN_SUB_PD_POOL = 409,
...
switch (yytype)
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      static
      symbol_type
      make_ALWAYS_INCLUDE_FQDN (location_type l)
      {
        return symbol_type (token::TOKEN_ALWAYS_INCLUDE_FQDN, std::move (l));
      }
#else
      static
      symbol_type
  ...
  private:
    ...
    {
      yyeof_ = 0,
      yylast_ = 985,     ///< Last index in yytable_.
      yynnts_ = 368,  ///< Number of nonterminal symbols.
