  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_next_server = 534,                     // next_server
        S_535_91 = 535,                          // $@91
        S_server_hostname = 536,                 // server_hostname
        S_537_92 = 537,                          // $@92
        S_boot_file_name = 538,                  // boot_file_name
        S_539_93 = 539,                          // $@93
        S_ip_address = 540,                      // ip_address
        S_541_94 = 541,                          // $@94
        S_duid = 542,                            // duid
        S_543_95 = 543,                          // $@95
        S_hw_address = 544,                      // hw_address
        S_545_96 = 545,                          // $@96
        S_client_id_value = 546,                 // client_id_value
        S_547_97 = 547,                          // $@97
        S_circuit_id_value = 548,                // circuit_id_value
        S_549_98 = 549,                          // $@98
        S_flex_id_value = 550,                   // flex_id_value
        S_551_99 = 551,                          // $@99
        S_hostname = 552,                        // hostname
        S_553_100 = 553,                         // $@100
        S_reservation_client_classes = 554,      // reservation_client_classes
        S_555_101 = 555,                         // $@101
        S_relay = 556,                           // relay
        S_557_102 = 557,                         // $@102
        S_relay_map = 558,                       // relay_map
        S_ip_addresses = 559,                    // ip_addresses
        S_560_103 = 560,                         // $@103
        S_client_classes = 561,                  // client_classes
        S_562_104 = 562,                         // $@104
        S_client_classes_list = 563,             // client_classes_list
        S_client_class_entry = 564,              // client_class_entry
        S_565_105 = 565,                         // $@105
        S_client_class_params = 566,             // client_class_params
        S_not_empty_client_class_params = 567,   // not_empty_client_class_params
        S_client_class_param = 568,              // client_class_param
        S_client_class_name = 569,               // client_class_name
        S_client_class_test = 570,               // client_class_test
        S_571_106 = 571,                         // $@106
        S_client_class_template_test = 572,      // client_class_template_test
        S_573_107 = 573,                         // $@107
        S_only_if_required = 574,                // only_if_required
        S_dhcp4o6_port = 575,                    // dhcp4o6_port
        S_control_socket = 576,                  // control_socket
        S_577_108 = 577,                         // $@108
        S_control_sockets = 578,                 // control_sockets
        S_579_109 = 579,                         // $@109
        S_control_socket_list = 580,             // control_socket_list
        S_not_empty_control_socket_list = 581,   // not_empty_control_socket_list
        S_control_socket_entry = 582,            // control_socket_entry
        S_583_110 = 583,                         // $@110
        S_control_socket_params = 584,           // control_socket_params
        S_control_socket_param = 585,            // control_socket_param
        S_control_socket_type = 586,             // control_socket_type
        S_587_111 = 587,                         // $@111
        S_control_socket_type_value = 588,       // control_socket_type_value
        S_control_socket_name = 589,             // control_socket_name
        S_590_112 = 590,                         // $@112
        S_control_socket_address = 591,          // control_socket_address
        S_592_113 = 592,                         // $@113
        S_control_socket_port = 593,             // control_socket_port
        S_cert_required = 594,                   // cert_required
        S_authentication = 595,                  // authentication
        S_596_114 = 596,                         // $@114
        S_auth_params = 597,                     // auth_params
        S_auth_param = 598,                      // auth_param
        S_auth_type = 599,                       // auth_type
        S_600_115 = 600,                         // $@115
        S_auth_type_value = 601,                 // auth_type_value
        S_realm = 602,                           // realm
        S_603_116 = 603,                         // $@116
        S_directory = 604,                       // directory
        S_605_117 = 605,                         // $@117
        S_clients = 606,                         // clients
        S_607_118 = 607,                         // $@118
        S_clients_list = 608,                    // clients_list
        S_not_empty_clients_list = 609,          // not_empty_clients_list
        S_basic_auth = 610,                      // basic_auth
        S_611_119 = 611,                         // $@119
        S_clients_params = 612,                  // clients_params
        S_clients_param = 613,                   // clients_param
        S_user_file = 614,                       // user_file
        S_615_120 = 615,                         // $@120
        S_password_file = 616,                   // password_file
        S_617_121 = 617,                         // $@121
        S_dhcp_queue_control = 618,              // dhcp_queue_control
        S_619_122 = 619,                         // $@122
        S_queue_control_params = 620,            // queue_control_params
        S_queue_control_param = 621,             // queue_control_param
        S_enable_queue = 622,                    // enable_queue
        S_queue_type = 623,                      // queue_type
        S_624_123 = 624,                         // $@123
        S_capacity = 625,                        // capacity
        S_arbitrary_map_entry = 626,             // arbitrary_map_entry
        S_627_124 = 627,                         // $@124
        S_dhcp_ddns = 628,                       // dhcp_ddns
        S_629_125 = 629,                         // $@125
        S_sub_dhcp_ddns = 630,                   // sub_dhcp_ddns
        S_631_126 = 631,                         // $@126
        S_dhcp_ddns_params = 632,                // dhcp_ddns_params
        S_dhcp_ddns_param = 633,                 // dhcp_ddns_param
        S_enable_updates = 634,                  // enable_updates
        S_server_ip = 635,                       // server_ip
        S_636_127 = 636,                         // $@127
        S_server_port = 637,                     // server_port
        S_sender_ip = 638,                       // sender_ip
        S_639_128 = 639,                         // $@128
        S_sender_port = 640,                     // sender_port
        S_max_queue_size = 641,                  // max_queue_size
        S_ncr_protocol = 642,                    // ncr_protocol
        S_643_129 = 643,                         // $@129
        S_ncr_protocol_value = 644,              // ncr_protocol_value
        S_ncr_format = 645,                      // ncr_format
        S_646_130 = 646,                         // $@130
        S_config_control = 647,                  // config_control
        S_648_131 = 648,                         // $@131
        S_sub_config_control = 649,              // sub_config_control
        S_650_132 = 650,                         // $@132
        S_config_control_params = 651,           // config_control_params
        S_config_control_param = 652,            // config_control_param
        S_config_databases = 653,                // config_databases
        S_654_133 = 654,                         // $@133
        S_config_fetch_wait_time = 655,          // config_fetch_wait_time
        S_loggers = 656,                         // loggers
        S_657_134 = 657,                         // $@134
        S_loggers_entries = 658,                 // loggers_entries
        S_logger_entry = 659,                    // logger_entry
        S_660_135 = 660,                         // $@135
        S_logger_params = 661,                   // logger_params
        S_logger_param = 662,                    // logger_param
        S_debuglevel = 663,                      // debuglevel
        S_severity = 664,                        // severity
        S_665_136 = 665,                         // $@136
        S_output_options_list = 666,             // output_options_list
        S_667_137 = 667,                         // $@137
        S_output_options_list_content = 668,     // output_options_list_content
        S_output_entry = 669,                    // output_entry
        S_670_138 = 670,                         // $@138
        S_output_params_list = 671,              // output_params_list
        S_output_params = 672,                   // output_params
        S_output = 673,                          // output
        S_674_139 = 674,                         // $@139
        S_flush = 675,                           // flush
        S_maxsize = 676,                         // maxsize
        S_maxver = 677,                          // maxver
        S_pattern = 678,                         // pattern
        S_679_140 = 679,                         // $@140
        S_compatibility = 680,                   // compatibility
        S_681_141 = 681,                         // $@141
        S_compatibility_params = 682,            // compatibility_params
        S_compatibility_param = 683,             // compatibility_param
        S_lenient_option_parsing = 684,          // lenient_option_parsing
        S_ignore_dhcp_server_identifier = 685,   // ignore_dhcp_server_identifier
        S_ignore_rai_link_selection = 686,       // ignore_rai_link_selection
        S_exclude_first_last_24 = 687            // exclude_first_last_24
      };
    };
...
switch (yykind)
  ...
  private:
    ...
    enum
    {
      ...
      yynnts_ = 461,  ///< Number of nonterminal symbols.
