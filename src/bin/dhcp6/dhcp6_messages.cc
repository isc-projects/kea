...
extern const isc::log::MessageID DHCP6_CB_REPAIR_MODE_ENABLED = "DHCP6_CB_REPAIR_MODE_ENABLED";
...
const char* values[] = {
    ...
    "DHCP6_CB_REPAIR_MODE_ENABLED", "Server is running in config back end repair mode.",
    ...
    "DHCP6_PACKET_DROP_DUPLICATE", "dropped as sent by the same client than a packet being processed by another thread: dropped %1 %2 by thread %3 as duplicate of %4 processed by thread %5",
