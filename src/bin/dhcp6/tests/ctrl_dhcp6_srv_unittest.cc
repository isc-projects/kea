...
public:
    ...
    using ControlledDhcpv6Srv::commandConfigTestHandler;
    using ControlledDhcpv6Srv::commandInterfaceRedetectHandler;
    using ControlledDhcpv6Srv::commandInterfaceAddHandler;
    using ControlledDhcpv6Srv::commandConfigBackendPullHandler;
};
...
TEST_F(CtrlChannelDhcpv6SrvTest, configReloadNotMain) {
    ASSERT_NO_THROW(server_.reset(new NakedControlledDhcpv6Srv()));
    ASSERT_TRUE(server_);
...
TEST_F(CtrlChannelDhcpv6SrvTest, configSetNotMain) {
    ASSERT_NO_THROW(server_.reset(new NakedControlledDhcpv6Srv()));
    ASSERT_TRUE(server_);
    MultiThreadingTest mt;
...
TEST_F(CtrlChannelDhcpv6SrvTest, configTestNotMain) {
    ASSERT_NO_THROW(server_.reset(new NakedControlledDhcpv6Srv()));
    ASSERT_TRUE(server_);
    MultiThreadingTest mt;
...
TEST_F(CtrlChannelDhcpv6SrvTest, interfaceRedetectNotMain) {
    ASSERT_NO_THROW(server_.reset(new NakedControlledDhcpv6Srv()));
    ASSERT_TRUE(server_);
    MultiThreadingTest mt;
...
TEST_F(CtrlChannelDhcpv6SrvTest, InterfaceAddNotMain) {
    ASSERT_NO_THROW(server_.reset(new NakedControlledDhcpv6Srv()));
    ASSERT_TRUE(server_);
    MultiThreadingTest mt;
...
TEST_F(CtrlChannelDhcpv6SrvTest, configBackendPullNotMain) {
    ASSERT_NO_THROW(server_.reset(new NakedControlledDhcpv6Srv()));
    ASSERT_TRUE(server_);
    MultiThreadingTest mt;
