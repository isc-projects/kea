...
TEST_F(HttpCtrlChannelDhcpv6Test, configSet) {
    ...
    EXPECT_EQ("[ { \"arguments\": { \"hash\": \"A95D95F0532DF3D85D8651759DDB468108D53B7AB754B0487D0918F7DC1BEEEF\" }, \"result\": 0, \"text\": \"Configuration successful.\" } ]",
              response);
    ...
    EXPECT_EQ("[ { \"arguments\": { \"hash\": \"BB18A666AD6F3C4D6598F70F53A625A39F65568F3213C7C9940F978055E27042\" }, \"result\": 0, \"text\": \"Configuration successful.\" } ]",
              response);
...
TEST_F(HttpCtrlChannelDhcpv6Test, configSetLFCRunning2) {
    createHttpChannelServer();
...
// Check that the "config-set" fails when LFC is running using a name.
TEST_F(HttpsCtrlChannelDhcpv6Test, configSetLFCRunning2) {
    createHttpChannelServer();
...
void
BaseCtrlChannelDhcpv6Test::testConfigReloadLFCRunning2() {
    createHttpChannelServer();
    std::string response;
...
TEST_F(HttpCtrlChannelDhcpv6Test, configReloadLFCRunning2) {
    testConfigReloadLFCRunning2();
}

TEST_F(HttpsCtrlChannelDhcpv6Test, configReloadLFCRunning2) {
    testConfigReloadLFCRunning2();
}
...
BaseCtrlChannelDhcpv6Test::testConfigReloadValid() {
    ...
    EXPECT_EQ("[ { \"arguments\": { \"hash\": \"AC3B67A5094CD2EE4E8FE46F56317B00492FCC74F6BA9F7287BAD48BF5446878\" }, \"result\": 0, \"text\": \"Configuration successful.\" } ]",
              response);
...
// which is added after server startup.
void
BaseCtrlChannelDhcpv6Test::testConfigTestDetectInterfaces() {
    interfaces_ = "\"eth0\"";
    IfacePtr eth0 = IfaceMgrTestConfig::createIface("eth0", ETH0_INDEX,
                                                    "11:22:33:44:55:66");
    auto detectIfaces = [&](bool update_only) {
...
TEST_F(HttpsCtrlChannelDhcpv6Test, configTestDetectInterfaces) {
    testConfigTestDetectInterfaces();
}
...
// which is added after server startup.
void
BaseCtrlChannelDhcpv6Test::testConfigSetDetectInterfaces() {
    interfaces_ = "\"eth0\"";
    IfacePtr eth0 = IfaceMgrTestConfig::createIface("eth0", ETH0_INDEX,
                                                    "11:22:33:44:55:66");
    auto detectIfaces = [&](bool update_only) {
...
TEST_F(HttpsCtrlChannelDhcpv6Test, configSetDetectInterfaces) {
    testConfigSetDetectInterfaces();
}
...
// Verify that the "config-set" command will exit with an error
TEST_F(HttpCtrlChannelDhcpv6Test, handleHttpToHttpsSwitchFatal) {
...
// Verify that the "config-set" command will exit with an error
TEST_F(HttpsCtrlChannelDhcpv6Test, handleHttpsToHttpSwitchFatal) {
    Daemon::setShutdownOnFailure(true);
    createHttpChannelServer();
