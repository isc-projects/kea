  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_525_88 = 525,                          // $@88
        S_pd_pools_list = 526,                   // pd_pools_list
        S_527_89 = 527,                          // $@89
        S_pd_pools_list_content = 528,           // pd_pools_list_content
        S_not_empty_pd_pools_list = 529,         // not_empty_pd_pools_list
        S_pd_pool_entry = 530,                   // pd_pool_entry
        S_531_90 = 531,                          // $@90
        S_sub_pd_pool = 532,                     // sub_pd_pool
        S_533_91 = 533,                          // $@91
        S_pd_pool_params = 534,                  // pd_pool_params
        S_pd_pool_param = 535,                   // pd_pool_param
        S_pd_prefix = 536,                       // pd_prefix
        S_537_92 = 537,                          // $@92
        S_pd_prefix_len = 538,                   // pd_prefix_len
        S_excluded_prefix = 539,                 // excluded_prefix
        S_540_93 = 540,                          // $@93
        S_excluded_prefix_len = 541,             // excluded_prefix_len
        S_pd_delegated_len = 542,                // pd_delegated_len
        S_reservations = 543,                    // reservations
        S_544_94 = 544,                          // $@94
        S_reservations_list = 545,               // reservations_list
        S_not_empty_reservations_list = 546,     // not_empty_reservations_list
        S_reservation = 547,                     // reservation
        S_548_95 = 548,                          // $@95
        S_sub_reservation = 549,                 // sub_reservation
        S_550_96 = 550,                          // $@96
        S_reservation_params = 551,              // reservation_params
        S_not_empty_reservation_params = 552,    // not_empty_reservation_params
        S_reservation_param = 553,               // reservation_param
        S_ip_addresses = 554,                    // ip_addresses
        S_555_97 = 555,                          // $@97
        S_prefixes = 556,                        // prefixes
        S_557_98 = 557,                          // $@98
        S_excluded_prefixes = 558,               // excluded_prefixes
        S_559_99 = 559,                          // $@99
        S_duid = 560,                            // duid
        S_561_100 = 561,                         // $@100
        ...
        S_601_113 = 601,                         // $@113
        S_control_sockets = 602,                 // control_sockets
        S_603_114 = 603,                         // $@114
        S_control_socket_list = 604,             // control_socket_list
        S_not_empty_control_socket_list = 605,   // not_empty_control_socket_list
        S_control_socket_entry = 606,            // control_socket_entry
        S_607_115 = 607,                         // $@115
        S_control_socket_params = 608,           // control_socket_params
        S_control_socket_param = 609,            // control_socket_param
        S_control_socket_type = 610,             // control_socket_type
        S_611_116 = 611,                         // $@116
        S_control_socket_type_value = 612,       // control_socket_type_value
        S_control_socket_name = 613,             // control_socket_name
        S_614_117 = 614,                         // $@117
        S_control_socket_address = 615,          // control_socket_address
        S_616_118 = 616,                         // $@118
        S_control_socket_port = 617,             // control_socket_port
        S_cert_required = 618,                   // cert_required
        S_authentication = 619,                  // authentication
        S_620_119 = 620,                         // $@119
        S_auth_params = 621,                     // auth_params
        S_auth_param = 622,                      // auth_param
        S_auth_type = 623,                       // auth_type
        S_624_120 = 624,                         // $@120
        S_auth_type_value = 625,                 // auth_type_value
        S_realm = 626,                           // realm
        S_627_121 = 627,                         // $@121
        S_directory = 628,                       // directory
        S_629_122 = 629,                         // $@122
        S_clients = 630,                         // clients
        S_631_123 = 631,                         // $@123
        S_clients_list = 632,                    // clients_list
        S_not_empty_clients_list = 633,          // not_empty_clients_list
        S_basic_auth = 634,                      // basic_auth
        S_635_124 = 635,                         // $@124
        S_clients_params = 636,                  // clients_params
        S_clients_param = 637,                   // clients_param
        S_user_file = 638,                       // user_file
        S_639_125 = 639,                         // $@125
        S_password_file = 640,                   // password_file
        S_641_126 = 641,                         // $@126
        S_dhcp_queue_control = 642,              // dhcp_queue_control
        S_643_127 = 643,                         // $@127
        S_queue_control_params = 644,            // queue_control_params
        S_queue_control_param = 645,             // queue_control_param
        S_enable_queue = 646,                    // enable_queue
        S_queue_type = 647,                      // queue_type
        S_648_128 = 648,                         // $@128
        S_capacity = 649,                        // capacity
        S_arbitrary_map_entry = 650,             // arbitrary_map_entry
        S_651_129 = 651,                         // $@129
        S_dhcp_ddns = 652,                       // dhcp_ddns
        S_653_130 = 653,                         // $@130
        S_sub_dhcp_ddns = 654,                   // sub_dhcp_ddns
        S_655_131 = 655,                         // $@131
        S_dhcp_ddns_params = 656,                // dhcp_ddns_params
        S_dhcp_ddns_param = 657,                 // dhcp_ddns_param
        S_enable_updates = 658,                  // enable_updates
        S_server_ip = 659,                       // server_ip
        S_660_132 = 660,                         // $@132
        S_server_port = 661,                     // server_port
        S_sender_ip = 662,                       // sender_ip
        S_663_133 = 663,                         // $@133
        S_sender_port = 664,                     // sender_port
        S_max_queue_size = 665,                  // max_queue_size
        S_ncr_protocol = 666,                    // ncr_protocol
        S_667_134 = 667,                         // $@134
        S_ncr_protocol_value = 668,              // ncr_protocol_value
        S_ncr_format = 669,                      // ncr_format
        S_670_135 = 670,                         // $@135
        S_config_control = 671,                  // config_control
        S_672_136 = 672,                         // $@136
        S_sub_config_control = 673,              // sub_config_control
        S_674_137 = 674,                         // $@137
        S_config_control_params = 675,           // config_control_params
        S_config_control_param = 676,            // config_control_param
        S_config_databases = 677,                // config_databases
        S_678_138 = 678,                         // $@138
        S_config_fetch_wait_time = 679,          // config_fetch_wait_time
        S_loggers = 680,                         // loggers
        S_681_139 = 681,                         // $@139
        S_loggers_entries = 682,                 // loggers_entries
        S_logger_entry = 683,                    // logger_entry
        S_684_140 = 684,                         // $@140
        S_logger_params = 685,                   // logger_params
        S_logger_param = 686,                    // logger_param
        S_debuglevel = 687,                      // debuglevel
        S_severity = 688,                        // severity
        S_689_141 = 689,                         // $@141
        S_output_options_list = 690,             // output_options_list
        S_691_142 = 691,                         // $@142
        S_output_options_list_content = 692,     // output_options_list_content
        S_output_entry = 693,                    // output_entry
        S_694_143 = 694,                         // $@143
        S_output_params_list = 695,              // output_params_list
        S_output_params = 696,                   // output_params
        S_output = 697,                          // output
        S_698_144 = 698,                         // $@144
        S_flush = 699,                           // flush
        S_maxsize = 700,                         // maxsize
        S_maxver = 701,                          // maxver
        S_pattern = 702,                         // pattern
        S_703_145 = 703,                         // $@145
        S_compatibility = 704,                   // compatibility
        S_705_146 = 705,                         // $@146
        S_compatibility_params = 706,            // compatibility_params
        S_compatibility_param = 707,             // compatibility_param
        S_lenient_option_parsing = 708           // lenient_option_parsing
      };
    };
...
switch (yykind)
  ...
  private:
    ...
    enum
    {
      yylast_ = 1437,     ///< Last index in yytable_.
