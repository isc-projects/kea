...
extern const isc::log::MessageID DATABASE_MYSQL_INITIAL_CONNECTION_FAIL;
extern const isc::log::MessageID DATABASE_MYSQL_NO_INIT_NO_ADMIN;
extern const isc::log::MessageID DATABASE_MYSQL_NO_INIT_NO_PASSWORD;
extern const isc::log::MessageID DATABASE_MYSQL_NO_INIT_READONLY;
...
extern const isc::log::MessageID DATABASE_PGSQL_INITIAL_CONNECTION_FAIL;
extern const isc::log::MessageID DATABASE_PGSQL_NO_INIT_NO_ADMIN;
extern const isc::log::MessageID DATABASE_PGSQL_NO_INIT_NO_PASSWORD;
extern const isc::log::MessageID DATABASE_PGSQL_NO_INIT_READONLY;
